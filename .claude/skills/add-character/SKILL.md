...
## Шаг 3 — Арт (Codex генерация → Design ревью)
...
2. ОБЯЗАТЕЛЬНО в ТЗ: стиль эталонной тройки (berserk_unarmed/dark_mage/guitarist —
   чистые линии, сочная дружелюбная палитра, позитив), РЕФЕРЕНСЫ-ИЗОБРАЖЕНИЯ
