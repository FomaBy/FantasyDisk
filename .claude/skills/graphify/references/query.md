...
```bash
python ".claude/skills/graphify/run.py" query "QUESTION"
# or: python ".claude/skills/graphify/run.py" query "QUESTION" --dfs --budget 3000
```
...
```bash
python ".claude/skills/graphify/run.py" path "NODE_A" "NODE_B"
```
...
```bash
python ".claude/skills/graphify/run.py" explain "NODE_NAME"
```
