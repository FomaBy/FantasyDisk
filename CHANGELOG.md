...
- VFX: опасные зоны (боссовские rift/disk-slam, элитный яд и лужи) переведены с голых программных кругов на оформленный телеграф→детонацию (HazardVfx) с бурлящими лужами яда.
