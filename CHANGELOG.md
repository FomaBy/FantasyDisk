...
- Чумной Берсерк (`mini_plague_berserker`) получил собственный 8-направленный
  PixelLab-пак (idle/move/attack/hit/death/skill_poison_volley по всем восьми
  ракурсам) вместо переиспользования спрайтов `plague_prophet` — вторая
  выделенная 8-направленная идентичность мини-элитки (FAN-2632).
