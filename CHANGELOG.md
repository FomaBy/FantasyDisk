...
- Шесть новых классов (фундамент): Ассасин, Рейнджер, Доктор, Химик, Рыцарь, Друид — статы, сигнатурное оружие с механиками архетипов, релевантность/аффинити/вознесение/кодекс; арт placeholder до итерации Codex.
