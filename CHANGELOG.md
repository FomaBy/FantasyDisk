...
- **Главное:** ультимейт теперь принадлежит оружию, а не классу — 51 отдельный
  приём вместо 17. Каждое из трёх орудий героя получило свою геометрию
  наведения, фазы каста и звук; раскадровка и эффекты у ультимейтов пока общие
  для класса, не для оружия — см. «Известные ограничения».
- **Главное:** в боевом интерфейсе появился отдельный виджет ультимейта — иконка
  выбранного оружия, шкала заряда, отметка готовности, подсказка прицеливания,
  глиф текущей клавиши или кнопки геймпада и описание приёма из Кодекса.
- **Главное:** появилось ручное прицеливание мышью и правым стиком для всех 51
  оружия. Режим выбирается в Настройках → Управление; автонаводка на ближайшего
  остаётся значением по умолчанию.
- **Главное:** ранние бои маршрута перестали быть одинаковыми: появились
  капитаны с бойцами свиты (Командир и Охотник), помеченная цель, предложение
  следующей фазы, редкий убегающий носитель награды и бонус за быструю зачистку.
- **Главное:** главное меню встречает новой картиной «Последний рубеж у
  Расколотого Диска»: трое закалённых героев на разрушенном бастионе перед
  костяным драконом и расколотым обсидиановым диском.
- **Главное:** macOS-сборка подписана Developer ID и нотаризована Apple —
  ручное подтверждение Gatekeeper «Всё равно открыть» больше не требуется.

### Изменения героев

- **Берсерк:** три ульты вместо одной — «Петля Палача» топора летит до края
  арены и детонирует на обратном пути, «Раскол Четырёх Сторон» молота бьёт
  четырьмя сторонами, диагоналями и центральным ударом, «Алый Вихрь» меча
  раскручивает три клинка по расширяющейся орбите.
- **Солдат:** винтовка прорезает коридор в плотном строю и добивает его тремя
  очередями, граната раскладывает семь зарядов кольцом, штык получил свой
  ближний приём.
- **Вор:** кошель, плащ и дымовая бомба получили разные ульты; уклонение внутри
  живого облака дымовой бомбы по-прежнему доходит до 90%, обычное уклонение —
  строго ниже 55%.
- **Элементалист:** метеорное ядро, кольцо сфер и призменный фокус разошлись по
  ролям, а сферы кольца наконец вращаются по заявленному радиусу, а не по
  сжатой орбите.
- **Снайпер:** прицельный пробой по самой живучей цели, девять небесных
  захватов с переносом метки и веер рикошетов с ограничением на одну цель;
  слабое место Deadeye открывается после захватывающего выстрела.
- **Священник:** кадило теперь действительно предотвращает урон, а не только
  показывает эффект; колокол и реликварий получили собственные приёмы.
- **Биолог:** инъектор, споровая линза и семя симбионта дают три разных способа
  разогнать заражение.
- **Робот:** гидравлический пресс, «Сингулярный Якорь» с гравитационной
  воронкой и удержанием обычных врагов, «Красная Зона» реактора с временным
  поглощением, которое честно снимается по завершении.
- **Инженер:** мины давления, ремонтный дрон с ограниченной привязкой лечения и
  турельный ключ — три разных ульты вместо общей.
- **Тёмный маг:** проклятый череп, тёмная книга и жезл получили отдельные
  приёмы; проклятия по-прежнему не разгоняются бесконечно на толпе.
- **Гитарист:** бас, электрогитара и усилитель развели ультимейты по ролям;
  исправлен радиус ауры усилителя.
- **Ассасин:** чакрамы, теневые кинжалы и ядовитая струна получили три
  непохожих приёма.
- **Рейнджер:** капкан, лунный арбалет и штормовой лук; лунная метка переходит
  только к живому врагу, а не остаётся на убитом, цикл заряда лука сохранён.
- **Доктор:** костяная пила, чумной шприц и лечебное зелье; ульты честно
  завершают свои эффекты и больше не копят заряд между боями сверх правил.
- **Химик:** «Царь-Колба» разливает растущее кислотное озеро, «Философский
  Взрыв» собирает пентаграмму и превращает пойманную группу, «Совершенный
  Гомункул» сливает постоянную пару в одного временного аватара.
- **Рыцарь:** святой цеп, длинное копьё и новая ульта башенного щита, которая
  действительно предотвращает урон.
- **Друид:** терновый посох, вороний тотем и амулет призыва; строй зверей стал
  стабильнее, а аура призывов масштабируется по общим правилам области.

### Added

- 51 ультимейт оружия для всех 17 героев: собственная геометрия наведения,
  фазы каста, ограничение суммарного урона по боссу и корректная уборка
  эффектов при отмене или смерти.
- Виджет ультимейта в боевом HUD с тултипом Кодекса.
- Ручное прицеливание курсором мыши и правым стиком геймпада; выбранный режим
  сохраняется между забегами.
- Разнообразие ранних боёв маршрута: колоды противников, капитаны Командир и
  Охотник, помеченная цель, предложение следующей фазы, носитель награды и
  награда за быструю зачистку. У таких узлов подсказка на карте маршрута
  заранее называет состав волны.

### Изменения

- Прокачка приведена к 16 каноническим осям. Защитных выборов ровно пять:
  здоровье, защита, уклонение, регенерация и вампиризм; поглощение и шанс
  вампиризма стали внутренними параметрами.
- Защита и уклонение работают по кривой с убывающей отдачей: вложения выше не
  дают линейного прироста и не выводят героя за безопасный предел.
- «+1 снаряд» теперь усиливает только те девять орудий, у которых
  действительно есть снаряды. Лишние трактовки (лишние капканы и мины, ширина
  вентилей реактора, дополнительные звенья цепи) убраны.
- «Лидерство» и «Сила призыва» выдаются только четырём классам с настоящими
  призывами — Гитаристу, Химику, Друиду и Инженеру; остальные больше не
  получают бесполезные награды и скрытый эхо-урон.
- Единый ритм роста урона, крита и периодических эффектов вместо разнобоя по
  классам.

### Исправления

- Мир боя полностью замирает на паузе: таймеры, снаряды и эффекты больше не
  продолжают идти под открытым меню.
- Кодекс показывает настоящие числа регенерации и вампиризма: база
  восстановления `0,16` в секунду и предел шанса вампиризма `20%` вместо
  устаревших значений.
- Канал обновлений macOS переключён на Developer ID-подпись и Apple
  notarization. Сборка остаётся fail-closed: без действительных Apple
  credentials или при отказе trust-проверок публикация не продолжится и не
  перейдёт молча на неподписанный fallback.
- Скачанный установщик проверяется повторно прямо перед запуском: если его
  размер или контрольная сумма больше не совпадают с данными релиза, файл
  удаляется и обновление не запускается.

### Известные ограничения

- Названия и описания ультимейтов в HUD и Кодексе пока общие для класса, хотя
  сам приём уже зависит от выбранного оружия.
- Визуал ультимейтов пока общий для класса, а не собственный для оружия: у
  части классов сцена ультимейта не содержит рисующих узлов, а обработчик
  тактов сводит все ультимейты к трём формам и двум цветам вместо авторской
  раскадровки. Исправление запланировано на 0.3.1.

## [0.2.4] — 2026-07-16

### Главное

- Обновления FantasyDisk теперь доступны всем игрокам из отдельного открытого
  каталога релизов: для проверки и скачивания больше не нужен вход в GitHub.
- Игра получает manifest, macOS DMG и Windows Setup только из публичного
  binary-only release source и продолжает проверять размер и SHA-256 каждого
  установщика.
- Telegram снова получает poster, DMG, Windows Setup и контрольные суммы каждого
  стабильного релиза; Discord сообщает игрокам прямую Telegram-ссылку.

### Исправления

- Исправлена недоступность автообновления и download links у игроков, вызванная
  приватностью основного репозитория с исходным кодом.
...
- **Главное:** новая игра сразу открывает выбор героя; история мира остаётся доступной в «Летописи» Кодекса, без обязательной заставки перед каждым новым забегом.
...
### Изменения героев
- **Берсерк:** молот теперь поражает настоящую круглую область; после экранов выбора движение включается только после отпускания направления.
- **Солдат:** оружие и баланс сохранены; герой получает общее исправление случайного движения после выбора.
- **Вор:** оружие и баланс сохранены; герой получает общее исправление случайного движения после выбора.
- **Элементалист:** оружие и баланс сохранены; герой получает общее исправление случайного движения после выбора.
- **Снайпер:** оружие и баланс сохранены; герой получает общее исправление случайного движения после выбора.
- **Священник:** оружие и баланс сохранены; герой получает общее исправление случайного движения после выбора.
- **Биолог:** оружие и баланс сохранены; герой получает общее исправление случайного движения после выбора.
- **Робот:** оружие и баланс сохранены; герой получает общее исправление случайного движения после выбора.
- **Инженер:** орбитальные дроны стали крупнее и заметнее, сохранив прежний темп атак; также исправлен случайный старт движения после выбора.
- **Тёмный маг:** оружие и баланс сохранены; герой получает общее исправление случайного движения после выбора.
- **Гитарист:** оружие и баланс сохранены; герой получает общее исправление случайного движения после выбора.
- **Ассасин:** оружие и баланс сохранены; герой получает общее исправление случайного движения после выбора.
- **Рейнджер:** оружие и баланс сохранены; герой получает общее исправление случайного движения после выбора.
- **Доктор:** оружие и баланс сохранены; герой получает общее исправление случайного движения после выбора.
- **Химик:** оружие и баланс сохранены; герой получает общее исправление случайного движения после выбора.
- **Рыцарь:** оружие и баланс сохранены; герой получает общее исправление случайного движения после выбора.
- **Друид:** оружие и баланс сохранены; герой получает общее исправление случайного движения после выбора.

### Added
- Игра проверяет публичные GitHub Releases при запуске и
  предлагает обновление, если доступна более новая версия. В настройках появилась
  кнопка «Обновить игру» для ручной проверки; загруженный DMG/Windows Setup
  запускается только после проверки размера и SHA-256.

### Changed
- Рассказ о мире больше не показывается при запуске игры: «Начать новую игру» и
  «Новая игра» ведут сразу к выбору героя. Вступление осталось только в Кодексе —
  запись «Вступление» на вкладке «Летопись».
- macOS DMG теперь показывает только нативные иконки FantasyDisk и Applications
  с одной минимальной стрелкой; декоративный фон, baked-подписи и видимые
  служебные каталоги удалены.
- Главное меню получило цельный кинематографичный фон: варвар стоит на утёсе над
  фиолетовым разломом диска, а левая зона остаётся спокойной для навигации.
- Кодекс получил новый мрачный фон святилища с более спокойной областью для текста.
- Орбитальные дроны Инженера стали крупнее и легче читаются в бою; их количество
  и темп атак не изменились.
- macOS DMG использует одобренный неподписанный канал и честно объясняет ручное
  подтверждение Gatekeeper; Windows по-прежнему поставляется одним NSIS Setup.

### Fixed
- АОЕ молота Берсерка снова круглая, а не овальная: убран вертикальный растяг
  зоны удара — область урона и эффект теперь совпадают вокруг точки удара у ног.
  Урон, дальность и перезарядка не изменились.
- Удержанное во время экрана выбора направление больше не переносится в бой:
  движение включается только после полного отпускания клавиш, стика или крестовины.
- Релизная macOS-сборка больше не допускает неявного переключения между
  подписанным и неподписанным каналами; выбранный канал всегда совпадает с
  предупреждением, которое видит игрок.
- Обновление игры честно помечает macOS-сборку как неподписанную: диалог
  обновления и сообщение после открытия DMG объясняют ручное подтверждение
  Gatekeeper (Системные настройки → Конфиденциальность и безопасность →
  «Всё равно открыть»), а заявление про «подписанный установщик» убрано.
- Фокус кнопок окна обновления больше не подсвечивается неподходящей ярко-жёлтой
  текстурой и остаётся одинаково читаемым с клавиатуры и геймпада.
...
- **Главное:** macOS-сборка заново подписывается после всех изменений и упаковывается в понятный DMG с перетаскиванием в Applications; для Windows выпускается один установщик.

### Баланс героев
- **Берсерк:** атаки по плотным группам стали стабильнее; топор и молот больше не создают случайных пиков урона.
- **Солдат:** урон штыка выровнен, а аркебуза, граната и ближняя стойка лучше сохраняют разные роли.
- **Вор:** усилены рикошеты монет, отравленный кинжал и дымовая бомба — весь набор стал надёжнее.
- **Элементалист:** Кольцо четырёх стихий выбирает ближайшую часть толпы и больше не разгоняется бесконечно.
...
- **Гитарист:** усилены рифф, бас-кольцо и усилители — класс заметно увереннее во всех трёх стилях.
...
### Added
- В Кодекс добавлена «Летопись» с историей мира, лорными вступлениями боссов и исходами победы и поражения.
- Новые открытия Кодекса теперь заметны прямо из игрового интерфейса.
- В форму обратной связи добавлены понятные настройки приватности перед отправкой текста и снимка экрана.

### Changed
- Кодекс приведён к стилю Атласа и Настроек, а описания всех героев стали короче и точнее.
- Главное меню получило новый фон: Берсерк стоит на обрыве над большим фиолетовым разломом диска.
- Визуальный импульс атаки игрока стал чище и лучше совпадает с моментом удара.

### Fixed
- Все 17 героев теперь стоят стопами на своей боевой позиции, включая ранее зависавших выше неё Инженера и Гитариста.
- После магазина больше нельзя открыть несколько взаимоисключающих продолжений маршрута.
- Исправлена загрузка Кодекса, «Летописи» и экранов исхода на чистой установке игры.

## [0.2.1] — 2026-07-12

### Release Highlights
- FantasyDisk 0.2.1 — большое обновление героев, оружия и Атласа: интерфейс стал цельнее, каждый класс получил собственную особенность, а каждое оружие — более узнаваемое поведение.
- **Главное:** у каждого из 17 классов появились три отдельные оружейные ветви созвездия — по одной для каждого оружия, с уникальными усилениями и финальными бунами.
- **Главное:** все 17 героев получили личные классовые трейты — от ярости Берсерка и дальнего расчёта Снайпера до молитвы Священника и ауры Друида.
- **Главное:** все 51 оружие теперь сильнее различаются дальностью, формой атаки, темпом, условиями применения и способом взаимодействия с толпой.
- **Главное:** основной забег стал собраннее и теперь состоит из двух актов, а ключевые игровые состояния получили полностью обновлённую музыку.

### Added
- Добавлены личные классовые особенности для всех героев. Они подчёркивают стиль конкретного персонажа и не усиливают другие классы.
- Добавлены три самостоятельные оружейные ветви Атласа для каждого класса и уникальный финальный бун для каждого оружия.
- Добавлен выбор боевой молитвы Священника: усиление урона, восстановление здоровья или защита.
- Добавлены точные русские описания узлов Атласа, чтобы заранее было понятно, как изменится оружие или герой.

### Changed
- Полностью обновлены главное меню, настройки, пауза, продолжение, выбор героя, Кодекс, маршрут и Атлас. Шрифты, кнопки, панели и навигация приведены к единому стилю и лучше адаптируются к разным разрешениям.
- Обычные, скрытые и финальные усиления Атласа стали заметнее; усилены ключевые ветви Атласа гильдии.
- Оружейное развитие сильнее влияет на поведение атак, а не только на числовые характеристики.
- Карта маршрута теперь целиком помещается на экран, а важные показатели во время боя стали заметнее.
- Структура забега сокращена до двух актов; темп развития героя, награды и сложность маршрута адаптированы под новую продолжительность.
- Музыка обновлена для главного меню, карты маршрута, магазина, обычных и элитных боёв, боссов, финальной битвы, победы и поражения.

### Fixed
- Исправлены наложения, обрезка текста и выход элементов интерфейса за доступную область.
- Навигация мышью, клавиатурой и геймпадом стала последовательнее на разных экранах.
- Улучшена надёжность настроек, продолжения забега и переноса прогресса после обновления.
...
## [Development archive] — 0.3.1 source cycle
...
- Добавлен машиночитаемый список ультимейтов `data/ultimates/feature_list.json`
  ...
  вывода, однократный прогрев кэша импорта Godot вне бюджета рецептов
  (холодная копия репозитория больше не даёт ложных «failed»), свежие доказательства `passing`, привязанные к SHA кандидата, дайджесту
...
- Ультимейт химика «Совершенный Гомункул» (`chemist/homunculus_vial`)
  перестроен под подачу Ultimate Direction v2 (FAN-2944, карточка FAN-2959):
  0.9-секундная церемония слияния, где танк и кастер сходятся внутри
  расширяющегося на весь экран алхимического круга, затемнение всего экрана и
  одна изумрудная вспышка слияния, гигант ростом с арену бьёт три раза с
  расходящимися во весь кадр кольцами, hitstop 120 мс и тряска камеры на
  ударах, приглушение звуков на всей активной фазе. Полная длительность
  сокращена с 5.4 с до 3.8 с при видимом расхождении пары обратно. Механика не
  менялась: все три удара исполнителя (1.75 / 2.60 / 3.45 с) остались внутри
  нарисованного активного окна. Снята с
  `PRESENTATION_V2_MIGRATION_ALLOWLIST`.
- Ультимейт инженера «Гнездо Часовых» (`engineer/engineer_sentry_wrench`)
  перестроен под подачу Ultimate Direction v2 (FAN-2944, карточка FAN-2960):
  0.8-секундная церемония каста с гигантским полупрозрачным сигилом
  ключа-часового над героем, затемнение всего экрана, шесть пилонов на
  арена-широком шестиугольнике с перекрёстными лучами через весь кадр,
  hitstop 110 мс и тряска камеры на первом ударе, приглушение звуков на
  залпе; полная длительность 3.8 с с видимым сворачиванием. Первая пара,
  снятая с `PRESENTATION_V2_MIGRATION_ALLOWLIST`.
...
- Гнилая Гончая (`mini_rot_hound`) получила полноценный 8-направленный
  ...
  8-направленного контракта не-игровых акторов (FAN-2628).
- Костяной Зовущий (`bone_caller`) получил полноценный 8-направленный
  PixelLab-пак (idle/move/attack/hit/death по всем восьми ракурсам) вместо
  одного авторского горизонтального ракурса с зеркалированием — первый живой
  пак 8-направленного контракта для `standard_monster` в этой ветке (FAN-2613).
- Костяной Шаман (`bone_shaman`) получил полноценный 8-направленный PixelLab-пак
  (idle/move/attack/hit/death по всем восьми ракурсам) вместо одного авторского
  горизонтального ракурса с зеркалированием (FAN-2618; исправление attack_west
  из approved candidate FAN-3036).
- Маг Пустоты (`void_mage`) получил полноценный 8-направленный PixelLab-пак
  (idle/move/attack/hit/death по всем восьми ракурсам) вместо одного
  авторского горизонтального ракурса с зеркалированием (FAN-2614).
- Железный Оплот (`iron_bastion`) получил полноценный 8-направленный
  PixelLab-пак (idle/move/attack/hit/death/skill_shield_block/skill_slam_wave
  по всем восьми ракурсам) вместо одностороннего набора кадров с
  зеркалированием — переделка отклонённого кандидата FAN-2620 (QA FAN-2755:
  облик персонажа был заменён на другой). Новый PixelLab-персонаж сгенерирован
  в режиме v3 с существующим спрайтом актора как `reference_image_base64`,
  чтобы сохранить облик (широкий латник, чёрно-золотая броня, фиолетовые
  трещины, башенный щит с черепом, шипастый моргенштерн) вместо редизайна.
  `hit`/`death`/`attack` пересозданы через v3 custom вместо шаблонов
  taking-punch/falling-back-death, которые давали разные по ракурсам цветовые
  артефакты (красные глаза, розовое пятно, оранжевые пятна, вспышка) — тот же
  класс межракурсного рассогласования, что и был отклонён QA. Реестр
  `scale`/`position` пересчитаны под новую нормализацию (245px видимой высоты
  / 32px нижнего отступа): `0.70`/`-82.0` → `0.59`/`-78.0`, чтобы ноги
  вернулись на прежнюю точку опоры. Старый недирекционный пак сохранён в
  `docs/design/backups/fan3093_iron_bastion_pre_directional/` (FAN-3093).

### Исправления

- **FAN-2608:** вор (thief) — устранён рывок в цикле ходьбы на север и
  северо-восток (кадры не замыкались в петлю, плащ пропадал и появлялся
  посреди анимации). Направления north/north-east пересозданы через PixelLab
  на той же безоружной ревизии персонажа; остальные 6 направлений не менялись.

### Процесс

- Слияние `ec2b3da2` на верхушке `dev` (родители `d915408c` и `667aa9e2`,
  2026-08-18T17:14:45Z) несёт подпись `TEST MERGE - will discard`. Это
  ошибка интегратора, а не черновик: содержимое — это состоявшаяся,
  QA-принятая интеграция FAN-2988 (доработка `bone_caller`), пропавшая
  подпись не отражает статус коммита. **Коммит `ec2b3da2` запрещено
  откатывать или удалять** — это реальная интеграция принятой работы.
  Диагностика и запрет отката: FAN-3034. Смежные карточки: интеграция
  FAN-3020, реализация FAN-2988, независимая QA FAN-2990.
