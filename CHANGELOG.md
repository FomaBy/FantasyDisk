...
- Железный Оплот (`iron_bastion`) получил полноценный 8-направленный
  ...
  по всем восьми ракурсам) вместо одного авторского ракурса с зеркалированием
  и без idle/hit покрытия — первый живой пак 8-направленного контракта для
  route-элитки (FAN-2620).
