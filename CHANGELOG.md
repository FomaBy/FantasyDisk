...
- Релизная macOS-сборка больше не допускает ad-hoc/unnotarized артефакт:
  Developer ID, app+DMG notarization, stapling и Gatekeeper `spctl` обязательны,
  иначе публикация останавливается.
