...
| `ui_btn_red_gold_codex_tab_*` | `assets/sprites/ui/frames/red_gold/ui_btn_red_gold_codex_tab.png` + hover/pressed/disabled | Historical Codex tab family; superseded in live runtime by FAN-1047 `text/back_260x104` |
