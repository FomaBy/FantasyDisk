...
| `main_menu_epic_battle_v3` | Сглаженный clean-art фон стартового экрана | `assets/backgrounds/main_menu_epic_battle_v3.png` | Active SCRUM-1001 фон главного меню: 2560x1440 OpenAI-generated clean cartoon-realistic D&D dark fantasy composition without baked UI, with left button-safe column, readable title-safe area, current sprite-inspired heroes/monsters/bosses, reduced grain, smooth-lines revision for less ragged contours and extra orange ember/spark dot noise removed |
