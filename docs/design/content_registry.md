...
| `dark_mage` | Темный маг | Магический урон, AoE, DoT, лучи | `scripts/progression_data.gd` | `assets/sprites/characters/dark_mage_spriteframes.tres`, `assets/sprites/characters/full_frame/dark_mage_pixellab/`, `assets/sprites/characters/pixellab/dark_mage/`, legacy `assets/sprites/characters/full_frame/dark_mage/`, `assets/sprites/characters/dark_mage.png`, `assets/sprites/characters/dark_mage_sheet.png`, `assets/sprites/characters/cartoon2/dark_mage/dark_mage_cartoon2_anim_sheet.png`, `assets/sprites/characters/cutout/dark_mage_*.png`, v2 source/runtime assets under `assets/sprites/characters/v2/dark_mage/`, skeleton-source package `docs/design/references/chars_cartoon/skeleton_parts/dark_mage/skeleton_source_manifest.json` | Реализовано; live Hero Select/runtime SpriteFrames use PixelLab v3 8-direction static rotations with one-frame idle/move/walk aliases; legacy SCRUM-473 cartoon2 full-frame assets remain history/fallback until a future PixelLab movement animation pass |
| `guitarist` | Гитарист | Звуковые волны, импульсы, ауры, отталкивание | `scripts/progression_data.gd` | `assets/sprites/characters/guitarist_spriteframes.tres`, `assets/sprites/characters/full_frame/guitarist_pixellab/`, `assets/sprites/characters/pixellab/guitarist/`, legacy `assets/sprites/characters/full_frame/guitarist/`, `assets/sprites/characters/guitarist.png`, `assets/sprites/characters/guitarist_sheet.png`, `assets/sprites/characters/cutout/guitarist_*.png`, v2 runtime/source assets under `assets/sprites/characters/v2/guitarist/` | Реализовано; live Hero Select/runtime SpriteFrames use PixelLab 8-direction static rotations with one-frame idle/move/walk aliases at Berserk-scale height; legacy SCRUM-429 v2 full-frame assets remain history/fallback until a future PixelLab movement animation pass |
