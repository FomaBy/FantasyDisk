...
- **Semantic typography (SCRUM-1061)**: `scripts/ui/semantic_typography.gd`
  ...
  два Atlas-canvas исключения переданы SCRUM-1068, а точный манифест остальных
  139 legacy cross-band sites — отдельному unassigned SCRUM-1073. SCRUM-1070
  остаётся только задачей ширины Atlas reset-footer и не владеет inventory-site.
  Continue Run
