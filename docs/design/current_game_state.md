...
Обновлено: 2026-07-02 (0.2.0 active dev snapshot)
...
- Текущий релизный snapshot: `0.2.0` на ветке `dev`; release `v0.1.6` уже выпущен
  и влит в `main`. Плановые версии `0.1.8` и `0.1.9` отменены/superseded.
