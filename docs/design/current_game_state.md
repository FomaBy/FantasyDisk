...
SCRUM-391 подготовил Design-ready кандидат для Settings tab switcher:
`assets/sprites/ui/frames/settings/ui_frame_settings_tab_switcher_3slot.png`
(`1280x256`, RGBA, ровно 3 вкладки). Runtime пока остается на старом
`ui_frame_settings_tab_switcher.png`, потому что нужно Back-end обновление
`SETTINGS_TAB_SWITCHER_FRAME_PATH`/safe rects; handoff:
