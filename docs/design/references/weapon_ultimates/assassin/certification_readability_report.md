...
Source commit: `3ba9055ee78ef4dcaed86f96b7be2c88b1eebf57`; source tree:
`52782ee775759a5e9fdcf07b4cea509de39462d3`. Godot 4.7 stable used the
...
| Venom wire | At 0.80s six anchors and the hex web are present. | At 2.80s the web and snap-collapse distinguish the impact without an undeclared global slowdown; the safe mode limits the photosensitive node. | At 3.25s the anchors and collapse remain legible while player contrast stays at least 0.588. |
