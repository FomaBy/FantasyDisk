...
Source commit: `c1399112ef3284facf22b1cad5503c29ac20da0b`; source tree:
`cb691c582a317af172db4cb43d388de9d8ae27d1`. Godot 4.7 stable used the
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Chakrams | 0.2867 | 0.504 | 0.744 | 0.0054 | 24 | 13 |
| Shadow daggers | 0.0339 | 0.567 | 0.458 | 0.0002 | 20 | 9 |
| Venom wire | 0.0240 | 0.567 | 0.629 | 0.0037 | 24 | 11 |
...
| Venom wire | At 0.80s six anchors and the hex web are present. | At 2.80s the web and snap-collapse distinguish the impact without an undeclared global slowdown; the safe mode limits the photosensitive node. | At 3.25s the anchors and collapse remain legible while player contrast stays at least 0.629. |
