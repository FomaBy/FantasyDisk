...
Source commit: `77ad159d781581cdbe9771987e8a9cd5fd524c1c`; source tree:
`08d97ff36ad5715c2508f639949aff0b5fc629bc`. Godot 4.7 stable used the
...
| Venom wire | At 0.80s six anchors and the hex web are present. | At 2.80s the web and snap-collapse distinguish the impact without an undeclared global slowdown; the safe mode limits the photosensitive node. | At 3.25s the anchors and collapse remain legible while player contrast stays at least 0.659. |
