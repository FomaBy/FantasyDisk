...
Source commit: `951ff46374891d9cbc3a1c396f051cdae8088c8f`; source tree:
`d2aad1a831cb9c158107d3cc31a6c71063fe9117`. Godot 4.7 stable used the
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Restore potion | 0.0293 | 0.545 | 0.463 | 0.0002 | 12 | 5 |
| Plague syringe | 0.0272 | 0.666 | 0.290 | 0.0002 | 12 | 6 |
