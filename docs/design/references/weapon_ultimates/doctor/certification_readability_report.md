...
Source commit: `0c92815c108a082886357b8581b186b0175174de`; source tree:
`b2a96c62519adc0aaeaab286bf5d477a6ba1e7a3`. Godot 4.7 stable used the
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Restore potion | 0.0293 | 0.545 | 0.423 | 0.0002 | 12 | 5 |
| Plague syringe | 0.0272 | 0.666 | 0.240 | 0.0002 | 12 | 6 |
| Bone saw | 0.0173 | 0.572 | 0.499 | 0.0002 | 12 | 8 |
