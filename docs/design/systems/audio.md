...
Этот файл описывает аудиосистему `dev` / версии 0.2. Snapshot полного состояния: `docs/design/current_game_state.md`. Канонические ID: `docs/design/content_registry.md`. Музыкальная подсистема введена в SCRUM-154; отчёты ревью — `docs/design/reviews/`.
