...
| `ranger` | `storm_longbow` | Грозовой длинный лук | `StormLongbow.tscn` | `storm_pierce_cone` | SCRUM-911: конус 5 пробивающих стрел (34°, дальность 980), пирс 4/стрела без спада, дедуп на залп; каждый хит отбрасывает от героя |
