...
- **FAN-1729 Прямая проверка soft-cap'а забеговых множителей в гейте Берсерка
  ...
  - Все приёмочные прогоны сняты под доказанной эксклюзивностью: раннер писал
    максимум живых процессов Godot на машине за окно каждого прогона, во всех 46
    прогонах `max_godot_procs=1` (свой процесс и ничей больше). Параллельный
    Godot воюет с времябазой, поэтому без этого замера числа не принимаются.
  ...
  - Ложных красных нет: 20 изолированных прогонов на кандидате — 20/20 зелёных,
    ...
    false-red 0. Строка `[soft-cap]` во всех 20 прогонах побитово одинаковая
