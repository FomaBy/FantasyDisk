...
- **FAN-1031 Методика live-замера (2026-07-13, координатор) — честный знаменатель DPS-окна.**
  `tools/character_balance_csv.gd::_measure_dps` делил урон на номинальные `WINDOW_SECONDS=8.0`
  при 480 кадрах: оружие стреляет в `_process(delta)`, тяжёлые 20-целевые кадры длиннее,
  игровое время окна убегало вперёд стены (профиль 3c-final: casts 6→67-68) — crowd-DPS
  раздувался до 12-16× (blast_powder 490k → 31.4k честных) и это был главный источник
  межпрогонного шума (см. FAN-1039). Фикс (`8dd7e4fb4`): знаменатель = фактическая сумма
  `get_process_delta_time()` за кадры окна. Probe: blast_powder 20t два прогона
  31392/31085 (±0.5%, было 12×); ideal-билды остаточно шумят ±30% (сидированный дро карт) —
  приёмочные числа = среднее 2 прогонов. CSV v1–v5 сравнимы только между собой (история
