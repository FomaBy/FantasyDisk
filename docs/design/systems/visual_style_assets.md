...
- `assets/backgrounds/field_stone_garden.png`, `field_marsh.png`, `field_dry_road.png`, `field_meadow.png` - active 2560x1440 combat backgrounds. As of 2026-06-12 they are flat top-down low-contrast ground textures without tall rocks, bushes, false object shadows or perspective props, so characters and monsters read as walking on the surface rather than over painted objects.
