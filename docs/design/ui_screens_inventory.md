...
Остаются блоки: выбор героя/оружия, карта маршрута, экономика (магазин/докача/дерево),
кодекс/настройки/патч-ноуты, исходы (победа/смерть как pause-end модалки).
