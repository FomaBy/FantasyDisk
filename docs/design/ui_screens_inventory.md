...
| Кнопка «Назад» | `HS4_BACK_2K` | 56 | 12 | 218 | 98 |
| Портрет-панель (фрейм) | `HS4_PORTRAIT_FRAME_2K` | 56 | 179 | 661 | 959 |
| Портрет (safe) | `HS4_PORTRAIT_SAFE_2K` | 85 | 208 | 603 | 901 |
...
| Слот карусели (первый; шаг X=239) | `HS4_CAROUSEL_SLOT_2K` | 218 | 1180 | 210 | 195 |
