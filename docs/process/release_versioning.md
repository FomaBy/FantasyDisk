...
Блок 0.1.3 снят релизом v0.1.3 (2026-06-12). Механизм: на время релизной
стабилизации PM включает feature block — в текущий релиз только bugfix/
regression/release-blocker, новые фичи в backlog следующей версии и не в
текущий sprint; changelog текущей версии не пополняется фичами после включения
блока. При планировании новой версии backlog переносится в её спринт.
