...
| [backend_shop_reentry_until_next_level_task.md](../tasks/backend_shop_reentry_until_next_level_task.md) | Back-end (геймплей/flow) | new | UX 0.1.5: магазин ревизитируем до перехода на след. уровень; первое закрытие уже даёт доступные узлы карты; продвижение этапа — при выборе след. узла, не при закрытии магазина |
| [design_reward_screens_redesign_per_reward_frames_task.md](../tasks/design_reward_screens_redesign_per_reward_frames_task.md) | Designer (Codex) | new | ART 0.2.0: редизайн наград за уровень (обычный/элитка) — каждая награда в своём фрейме нового стиля, фреймы скиллом; no-overlap, текст читаем (детал. SCRUM-328) |
| [backend_attack_vfx_runtime_coverage_task.md](../tasks/backend_attack_vfx_runtime_coverage_task.md) | Back-end/Codex | done | Jira: SCRUM-335. Runtime VFX coverage done: existing `vfx_weapon_*` routed through BerserkWeapon/Knight melee, enemy projectile trail+impact added, docs/tests updated; full skill-based asset regen handed off as blocked SCRUM-337 due missing `OPENAI_API_KEY` |
...
| [art_ui_overhaul_dnd_dark_fantasy_anchor_task.md](../tasks/art_ui_overhaul_dnd_dark_fantasy_anchor_task.md) | Designer+Back-end | new | ART 0.2.0 ОПОРНАЯ: UI Overhaul D&D+Dark Fantasy Dragon — стайл-гайд + общие атомы (кнопки/рамки/курсор/подложки) новым скиллом, прозрачный фон, assets+references; блокирует 6 кластеров |
| [art_ui_overhaul_menus_settings_task.md](../tasks/art_ui_overhaul_menus_settings_task.md) | Designer (Codex) | blocked | ART 0.2.0: UI Overhaul «Меню и настройки» (D&D Dark Fantasy Dragon, новый скилл, прозрачный фон) — экраны: menus_settings; ждёт опорную |
| [art_ui_overhaul_combat_hud_task.md](../tasks/art_ui_overhaul_combat_hud_task.md) | Designer (Codex) | blocked | ART 0.2.0: UI Overhaul «Боевой HUD, баннеры и тосты» (D&D Dark Fantasy Dragon, новый скилл, прозрачный фон) — экраны: combat_hud; ждёт опорную |
| [art_ui_overhaul_levelup_rewards_task.md](../tasks/art_ui_overhaul_levelup_rewards_task.md) | Designer (Codex) | blocked | ART 0.2.0: UI Overhaul «Повышение уровня и награды» (D&D Dark Fantasy Dragon, новый скилл, прозрачный фон) — экраны: levelup_rewards; ждёт опорную |
| [art_ui_overhaul_shop_economy_task.md](../tasks/art_ui_overhaul_shop_economy_task.md) | Designer (Codex) | blocked | ART 0.2.0: UI Overhaul «Магазин и узлы экономики» (D&D Dark Fantasy Dragon, новый скилл, прозрачный фон) — экраны: shop_economy; ждёт опорную |
| [art_ui_overhaul_progression_codex_task.md](../tasks/art_ui_overhaul_progression_codex_task.md) | Designer (Codex) | blocked | ART 0.2.0: UI Overhaul «Прогрессия и кодекс» (D&D Dark Fantasy Dragon, новый скилл, прозрачный фон) — экраны: progression_codex; ждёт опорную |
| [art_ui_overhaul_pause_end_task.md](../tasks/art_ui_overhaul_pause_end_task.md) | Designer (Codex) | blocked | ART 0.2.0: UI Overhaul «Пауза и финальные экраны» (D&D Dark Fantasy Dragon, новый скилл, прозрачный фон) — экраны: pause_end; ждёт опорную |
...
| [design_hero_select_dossier_frame_from_descriptionhs_ref_task.md](../tasks/design_hero_select_dossier_frame_from_descriptionhs_ref_task.md) | Designer (Codex) | new | Jira: SCRUM-323. ART 0.1.5: технический фрейм описания героя + Возвышения + start button из DescriptionHS → slot `dossier`; proportional scale/no one-axis stretch; content-zone ≥320px; без нового художественного ТЗ |
| [design_hero_select_windrose_radar_frame_from_ref_task.md](../tasks/design_hero_select_windrose_radar_frame_from_ref_task.md) | Designer (Codex) | in_progress | Jira: SCRUM-322. В работе: windrose/radar frame из reference, цельный proportional square layer без 9-slice/one-axis stretch; radar content только в safe inner circle |
