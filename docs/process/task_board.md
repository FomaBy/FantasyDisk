...
| [design_integrate_generated_settings_tab_switcher_frame_task.md](../tasks/design_integrate_generated_settings_tab_switcher_frame_task.md) | Designer (Codex) | new | Jira: SCRUM-325. Сгенерирован reference/preview фрейма вкладок настроек D&D + Dark Fantasy; нужна приемка/runtime-интеграция; labels/click zones только в content-zone, не на рамке |
...
| [design_hero_select_carousel_frame_from_carusel_ref_task.md](../tasks/design_hero_select_carousel_frame_from_carusel_ref_task.md) | Designer (Codex) | review | Jira: SCRUM-320. Carusel thumbnail strip applied as whole-image proportional `TextureRect` (1024×170/1536×255/2048×340, no one-axis stretch); live `ui_frame_hero_select_thumbnail_strip.png` rebuilt as 1536×255 RGBA, backup in `build/cleanup_backup_hero_select_carousel_2026_06_14/`, screenshots `build/qa/scrum320/`, smokes PASS |
