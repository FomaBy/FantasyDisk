...
| [design_hero_select_replace_frames_herouiframe_task.md](../tasks/design_hero_select_replace_frames_herouiframe_task.md) | Designer (Codex) | in_progress | Jira: SCRUM-281. **РЕГРЕСС (репорт юзера 2026-06-14): экран выбора персонажа ПОЛНОСТЬЮ СЛОМАН — интерфейс/текст пересекаются, миниатюры кривые.** DONE только когда всё чётко и по местам (нет overlap, миниатюры ровные, элементы в рамках) на 1280/1920/2560; QA смотрит живой экран, визуальный регресс = FAILED. Закрывает SCRUM-276 |
