...
| --- | --- | --- | --- |
| [backend_add_character_soldier_task.md](../tasks/backend_add_character_soldier_task.md) | Back-end (конвейер класса) | in_progress | Jira: SCRUM-168; dispatched Back-end `019eabd9-780b-78a2-9f4b-e7203d659ef2` 2026-06-12. Новый персонаж «Солдат» по .claude/skills/add-character/SKILL.md: 3 уникальных оружия, codex-арт, риг, тесты, доки; Back-end owns gameplay/balance/integration, art -> Design handoff, rig/motion/attack poses -> Animator handoff |
| [backend_add_character_thief_task.md](../tasks/backend_add_character_thief_task.md) | Back-end (конвейер класса) | blocked | Jira: SCRUM-169; Новый персонаж «Вор» по .claude/skills/add-character/SKILL.md: 3 уникальных оружия, codex-арт, риг, тесты, доки; цепочка add-character: разблокирует предыдущий класс по done (общие файлы) |
