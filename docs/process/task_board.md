...
| --- | --- | --- | --- |
| [bug_hud_elements_overlap_task.md](../tasks/bug_hud_elements_overlap_task.md) | Back-end (UI) | new | Jira: SCRUM-161; БАГ (скриншот пользователя): таймер наползает на ULT-панель в широком/узком окне; верхний HUD без пересечений на 3 размерах + переиспользуемый no-overlap тест-хелпер фактических global_rect. Введено правило qa_protocol «UI не наползает» |
| [backend_shop_wall_artifacts_frameless_task.md](../tasks/backend_shop_wall_artifacts_frameless_task.md) | Back-end (UI) | new | Jira: SCRUM-160; Магазин: убрать рамки-карточки — артефакты висят на стене лавки (тень, компактный ценник, hover-подсветка, куплено=снят со стены); тест непересечения rect; скриншот в build/qa/ |
| [backend_ingame_patch_notes_task.md](../tasks/backend_ingame_patch_notes_task.md) | Back-end (UI+данные) | new | Jira: SCRUM-159; Экран «Что нового» в главном меню: data-driven патч-ноуты по-русски для игрока (ретроспектива 0.1.0-0.1.4), бейдж новой версии после обновления (не модалка), вписан в релизный чек-лист (шаг 11) |
...
| [backend_drop_economy_rebalance_task.md](../tasks/backend_drop_economy_rebalance_task.md) | Back-end (баланс, Claude) | in_progress | Jira: SCRUM-153; dispatched Back-end `019eabd9-780b-78a2-9f4b-e7203d659ef2` 2026-06-12. Дроп по классам целей (жирные ×1.5-2, мини ×3-4, элитки ×6-10, боссы фикс+этап) + согласованное подорожание всего за золото; чистая покупательная способность +10-15%, кривая уровней ±10-15%; не конфликтовать по файлам со SCRUM-149 |
