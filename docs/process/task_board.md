...
| --- | --- | --- | --- |
| [backend_quit_confirmation_dialog_and_escape_task.md](../tasks/backend_quit_confirmation_dialog_and_escape_task.md) | Back-end (UI) | blocked | Jira: SCRUM-319. UX 0.1.5: диалог подтверждения выхода + Escape в главном меню; sequential hold while SCRUM-318 Back-end UI hover pass is active in `scripts/ui_screens.gd` / `tests/runtime_smoke_test.gd` |
