...
| --- | --- | --- | --- |
| [design_hero_select_dossier_frame_from_descriptionhs_ref_task.md](../tasks/design_hero_select_dossier_frame_from_descriptionhs_ref_task.md) | Designer (Codex) | new | ART 0.1.5: рамка описания героя (центр) из референса DescriptionHS → слот dossier, занимает всё свободное место; контент в content-зоне (закрывает SCRUM-276) |
...
| [design_hero_select_carousel_frame_from_carusel_ref_task.md](../tasks/design_hero_select_carousel_frame_from_carusel_ref_task.md) | Designer (Codex) | review | Jira: SCRUM-320. Carusel thumbnail strip applied: live `ui_frame_hero_select_thumbnail_strip.png` rebuilt as 1536×255 RGBA from reference, backup in `build/cleanup_backup_hero_select_carousel_2026_06_14/`, screenshots `build/qa/scrum320/`, UI/theme/no-overlap/runtime/combat/progression/weapon smokes PASS |
