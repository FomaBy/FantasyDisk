...
| [animation_soldier_rig_motion_task.md](../tasks/animation_soldier_rig_motion_task.md) | Animator (Codex) | new | Jira: SCRUM-168; Design art ready, proceed with cutout rig/profile/attack pose hooks for rifle/grenade/bayonet using `assets/sprites/characters/soldier.png` |
...
| [codex_design_thief_art_task.md](../tasks/codex_design_thief_art_task.md) | Design (Codex) | new | Jira: SCRUM-169; нужен canonical `thief.png` + 3 weapon PNG (`thief_coin_pouch`, `thief_shadow_cloak`, `thief_smoke_bomb`); Back-end использует fallback textures до готовности |
| [animation_thief_rig_motion_task.md](../tasks/animation_thief_rig_motion_task.md) | Animator (Codex) | blocked | Jira: SCRUM-169; ждет `assets/sprites/characters/thief.png`, затем cutout rig/profile/attack pose hooks для coin/backstab/smoke |
| [backend_add_character_elementalist_task.md](../tasks/backend_add_character_elementalist_task.md) | Back-end (конвейер класса) | new | Jira: SCRUM-163; разблокирована после done `backend_add_character_thief_task.md`. Новый персонаж «Элементалист» по .claude/skills/add-character/SKILL.md: 3 уникальных оружия, codex-арт, риг, тесты, доки |
| [backend_add_character_sniper_task.md](../tasks/backend_add_character_sniper_task.md) | Back-end (конвейер класса) | blocked | Jira: SCRUM-167; Новый персонаж «Снайпер» по .claude/skills/add-character/SKILL.md: 3 уникальных оружия, codex-арт, риг, тесты, доки; цепочка add-character: разблокирует предыдущий класс по done (общие файлы) |
| [backend_add_character_priest_task.md](../tasks/backend_add_character_priest_task.md) | Back-end (конвейер класса) | blocked | Jira: SCRUM-165; Новый персонаж «Священник» по .claude/skills/add-character/SKILL.md: 3 уникальных оружия, codex-арт, риг, тесты, доки; цепочка add-character: разблокирует предыдущий класс по done (общие файлы) |
| [backend_add_character_biologist_task.md](../tasks/backend_add_character_biologist_task.md) | Back-end (конвейер класса) | blocked | Jira: SCRUM-162; Новый персонаж «Биолог» по .claude/skills/add-character/SKILL.md: 3 уникальных оружия, codex-арт, риг, тесты, доки; цепочка add-character: разблокирует предыдущий класс по done (общие файлы) |
| [backend_add_character_robot_task.md](../tasks/backend_add_character_robot_task.md) | Back-end (конвейер класса) | blocked | Jira: SCRUM-166; Новый персонаж «Робот» по .claude/skills/add-character/SKILL.md: 3 уникальных оружия, codex-арт, риг, тесты, доки; цепочка add-character: разблокирует предыдущий класс по done (общие файлы) |
| [backend_add_character_engineer_task.md](../tasks/backend_add_character_engineer_task.md) | Back-end (конвейер класса) | blocked | Jira: SCRUM-164; Новый персонаж «Инженер» по .claude/skills/add-character/SKILL.md: 3 уникальных оружия, codex-арт, риг, тесты, доки; цепочка add-character: разблокирует предыдущий класс по done (общие файлы) |
...
| [backend_shop_wall_artifacts_frameless_task.md](../tasks/backend_shop_wall_artifacts_frameless_task.md) | Back-end (UI) | in_progress | Jira: SCRUM-160; dispatched Back-end `019eabd9-780b-78a2-9f4b-e7203d659ef2` 2026-06-12. Магазин: убрать рамки-карточки — артефакты висят на стене лавки (тень, компактный ценник, hover-подсветка, куплено=снят со стены); тест непересечения rect; скриншот в build/qa/ |
| [backend_ingame_patch_notes_task.md](../tasks/backend_ingame_patch_notes_task.md) | Back-end (UI+данные) | in_progress | Jira: SCRUM-159; dispatched Back-end `019eabd9-780b-78a2-9f4b-e7203d659ef2` 2026-06-12. Экран «Что нового» в главном меню: data-driven патч-ноуты по-русски для игрока (ретроспектива 0.1.0-0.1.4), бейдж новой версии после обновления (не модалка), вписан в релизный чек-лист (шаг 11) |
...
| --- | --- | --- | --- | --- | --- |
| [bug_head_broken_uncommitted_drop_economy_task.md](../tasks/bug_head_broken_uncommitted_drop_economy_task.md) | **critical** | Back-end | new | git-гигиена / SCRUM-153/155 | **HEAD e206bd7 не компилируется на чистом чекауте**: combat_director вызывает drop_class_rewards (в HEAD), а определения SCRUM-153 не закоммичены (+229 строк в рабочем дереве). CI/релиз с HEAD красные. Закоммитить экономику немедленно |
