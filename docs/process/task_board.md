...
| [backend_add_character_thief_task.md](../tasks/backend_add_character_thief_task.md) | Back-end (конвейер класса) | in_progress | Jira: SCRUM-169; dispatched Back-end `019eabd9-780b-78a2-9f4b-e7203d659ef2` 2026-06-12. Разблокирована после done `backend_add_character_soldier_task.md`. Новый персонаж «Вор» по .claude/skills/add-character/SKILL.md: 3 уникальных оружия, codex-арт, риг, тесты, доки; цепочка add-character: разблокирует предыдущий класс по done (общие файлы) |
| [backend_add_character_elementalist_task.md](../tasks/backend_add_character_elementalist_task.md) | Back-end (конвейер класса) | blocked | Jira: SCRUM-163; Новый персонаж «Элементалист» по .claude/skills/add-character/SKILL.md: 3 уникальных оружия, codex-арт, риг, тесты, доки; цепочка add-character: разблокирует предыдущий класс по done (общие файлы) |
...
| [backend_music_tavern_ambient_task.md](../tasks/backend_music_tavern_ambient_task.md) | Back-end (Claude, ресёрч+интеграция) | in_progress | Jira: SCRUM-154; dispatched Back-end `019eabd9-780b-78a2-9f4b-e7203d659ef2` 2026-06-12. Замена музыки на струнный тавернный эмбиент (лютня/арфа/гитара): меню + бой (+опц. босс), только CC0/CC-BY с фиксацией лицензий и атрибуцией, бесшовный луп, нормализация, кроссфейд меню↔бой |
