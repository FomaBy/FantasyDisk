...
| --- | --- | --- | --- |
| [design_summon_creatures_animation_glow_task.md](../tasks/design_summon_creatures_animation_glow_task.md) | Design (Claude-Designer; генерация кадров — Codex) | in_progress | Jira: SCRUM-336. Анимация move+attack всех призывных существ по эталону волка (pack_spirit/homunculus/leadership_echo) + белое контурное свечение КО ВСЕМ спрайтам призыва (видимость на аренах). Glow — PIL сейчас; рисованные кадры — Codex |
| [backend_hero_select_redesign_master_layout_task.md](../tasks/backend_hero_select_redesign_master_layout_task.md) | Back-end (UI) | in_progress | Jira: SCRUM-333. UX 0.1.5 МАСТЕР: редизайн выбора героя — превью 1/3 слева, описание+возвышение 2/3, роза ветров top-right, карусель снизу с hover-подсветкой+tooltip; рамки скиллом; no-overlap, текст читаем |
...
| [backend_integrate_settings_tab_switcher_frame_task.md](../tasks/backend_integrate_settings_tab_switcher_frame_task.md) | Back-end | new | Jira: SCRUM-334. Handoff from SCRUM-325. Подключить `ui_frame_settings_tab_switcher.png` к SettingsTabs; соблюдать safe rects/content-zone, не класть labels/click zones на орнамент |
| [design_integrate_generated_settings_tab_switcher_frame_task.md](../tasks/design_integrate_generated_settings_tab_switcher_frame_task.md) | Designer (Codex) | review | Jira: SCRUM-325. Settings tab switcher accepted as production PNG `assets/sprites/ui/frames/settings/ui_frame_settings_tab_switcher.png` (1280×256 RGBA); safe-area preview/docs done; runtime integration handed off to Back-end SCRUM-334 |
...
| [design_hero_select_portrait_frame_from_heroframe_ref_task.md](../tasks/design_hero_select_portrait_frame_from_heroframe_ref_task.md) | Designer (Codex) | new | Jira: SCRUM-321. ART 0.1.5: рамка превью героя слева из референса heroframe (997×1578, proportional scale/no one-axis stretch) → слот portrait; портрет в content-зоне |
| [design_hero_select_carousel_frame_from_carusel_ref_task.md](../tasks/design_hero_select_carousel_frame_from_carusel_ref_task.md) | Designer (Codex) | review | Jira: SCRUM-320. Carusel thumbnail strip applied as whole-image proportional `TextureRect` (1024×170/1536×255/2048×340, no one-axis stretch); content-zone margins 112/46/112/46 keep thumbnails off ornament; live PNG/backup/screenshots in place; smokes PASS |
