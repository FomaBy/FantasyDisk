...
| [design_integrate_generated_settings_tab_switcher_frame_task.md](../tasks/design_integrate_generated_settings_tab_switcher_frame_task.md) | Designer (Codex) | new | Jira: SCRUM-325. Передано в Design thread `019eabf1-6d54-7561-8af9-ce25cdf483a9`: внедрить новый вид tabs настроек; labels/click zones только в content-zone |
