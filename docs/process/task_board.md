...
| --- | --- | --- | --- |
| [backend_add_character_soldier_task.md](../tasks/backend_add_character_soldier_task.md) | Back-end (конвейер класса) | new | Jira: SCRUM-168; Новый персонаж «Солдат» по .claude/skills/add-character/SKILL.md: 3 уникальных оружия, codex-арт, риг, тесты, доки; конвейер add-character (скилл), ПЕРВЫЙ в цепочке — можно брать |
...
| [bug_hud_elements_overlap_task.md](../tasks/bug_hud_elements_overlap_task.md) | Back-end (UI) | in_progress | Jira: SCRUM-161; dispatched Back-end `019eabd9-780b-78a2-9f4b-e7203d659ef2` 2026-06-12. БАГ (скриншот пользователя): таймер наползает на ULT-панель в широком/узком окне; верхний HUD без пересечений на 3 размерах + переиспользуемый no-overlap тест-хелпер фактических global_rect. Введено правило qa_protocol «UI не наползает» |
...
| [design_codex_screen_backdrops_main_menu_task.md](../tasks/design_codex_screen_backdrops_main_menu_task.md) | Design (Codex генерация) → Claude-Designer | in_progress | Jira: SCRUM-158; dispatched Design `019eabf1-6d54-7561-8af9-ce25cdf483a9` 2026-06-12. Фоны-подложки 2560x1440 для всех экранов с центральным окном (3-5 вариаций по ролям, спокойный центр) + новый арт главного меню с боссами/персонажами игры; канон dark fantasy (референсы ui_dark_fantasy_2026_06), координация со SCRUM-147 |
| [backend_new_bosses_mini_elites_roster_task.md](../tasks/backend_new_bosses_mini_elites_roster_task.md) | Back-end (Claude) | in_progress | Jira: SCRUM-155; dispatched Back-end `019eabd9-780b-78a2-9f4b-e7203d659ef2` 2026-06-12. 3 новых босса (Костяной Архонт, Матерь Роя, Пепельный Колосс) + 6 видов мини-элиток для свиты Возвышения L7: фазовые паттерны, HazardVfx-телеграфы, data-driven виды, кодекс, ротация боссов из 5; арт — парная design-задача SCRUM-156, до готовности — placeholder'ы |
