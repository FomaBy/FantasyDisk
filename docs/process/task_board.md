...
| [design_codex_summon_allies_sprites_task.md](../tasks/design_codex_summon_allies_sprites_task.md) | Design (Codex генерация) → Claude-Designer | review | Jira: SCRUM-152; 6 союзных/deployable PNG в `assets/sprites/allies/`, `AllyMinion` получил raster fallback, preview-листы готовы; Back-end handoff `backend_summon_allies_source_sprite_integration_task.md`; import green, runtime smoke blocked внешним `SoundWaveVfx` cleanup |
...
| [design_codex_elite_boss_sprite_resolution_upscale_task.md](../tasks/design_codex_elite_boss_sprite_resolution_upscale_task.md) | Design (Codex) → Claude-Designer | done | Jira: SCRUM-135; 4 элитки + 2 босса заменены на native 512px, cutout rig перенарезан, manifest 512, previews `elite_boss_upscale_*`; import + animation smoke green, runtime smoke blocked внешней Escape/level-up worktree правкой | -> Design review ПРИНЯТО 2026-06-12: 512px native, манифест 512, cutout синхронен (пиксель-в-пиксель), animation smoke green; готово к QA
