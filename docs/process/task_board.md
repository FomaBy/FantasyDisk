...
| [design_codex_summon_allies_sprites_task.md](../tasks/design_codex_summon_allies_sprites_task.md) | Design (Codex генерация) → Claude-Designer | in_progress | Jira: SCRUM-152; dispatched Design `019eabf1-6d54-7561-8af9-ce25cdf483a9` 2026-06-12. Спрайты ВСЕХ призывных союзников в D&D-каноне (у AllyMinion сейчас вообще нет спрайта): питомцы/стая Друида, эхо Лидерства, гомункул Химика, амп Гитариста как полевой объект; различимость «свой/чужой», превью-лист масштаба, качество не ниже канона персонажей |
...
| [design_codex_elite_boss_sprite_resolution_upscale_task.md](../tasks/design_codex_elite_boss_sprite_resolution_upscale_task.md) | Design (Codex) → Claude-Designer | review | Jira: SCRUM-135; 4 элитки + 2 босса заменены на native 512px, cutout rig перенарезан, manifest 512, previews `elite_boss_upscale_*`; import + animation smoke green, runtime smoke blocked внешней Escape/level-up worktree правкой |
