...
| [backend_settings_volume_slider_ux_task.md](../tasks/backend_settings_volume_slider_ux_task.md) | Back-end (UI) | in_progress | Jira: SCRUM-151; dispatched Back-end `019eabd9-780b-78a2-9f4b-e7203d659ef2` 2026-06-12. Настройки/Звук: трек слайдера не отрисовывается (виден только грабер), нужен видимый трек с заливкой, клик-по-треку, крупный хват, живое изменение звука, понятный mute; скриншот после правки в build/qa/ |
