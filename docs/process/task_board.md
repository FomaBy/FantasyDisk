...
| [bug_button_hover_remove_yellow_glow_task.md](../tasks/bug_button_hover_remove_yellow_glow_task.md) | Back-end (UI) | in_progress | Jira: SCRUM-318. SCRUM-281 QA PASSED, blocker снят; Back-end hover/focus pass: remove yellow/gold glow from button states, keep neutral brighter hover/focus |
