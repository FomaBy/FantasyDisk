...
| --- | --- | --- | --- |
| [backend_survivability_rebalance_vampirism_nerf_weighted_levelup_task.md](../tasks/backend_survivability_rebalance_vampirism_nerf_weighted_levelup_task.md) | Back-end (баланс, Claude) | new | Jira: SCRUM-149; Нерф вампиризма (убрать/закапать +50% урона в лечение — сейчас бессмертие), усилить реген/броню/уклонение до конкурентных пиков, пересмотр атрибут×класс (единый источник с SCRUM-146), взвешенные награды level-up по характеристикам с floor; balance harness до/после, DPS ±10% |
| [backend_victory_screen_player_facing_text_task.md](../tasks/backend_victory_screen_player_facing_text_task.md) | Back-end (UI-текст) | new | Jira: SCRUM-148; спринт 0.1.4 — можно брать в работу (фриз снят релизом v0.1.3). Экран победы: только пользовательская информация на русском — убрать «Meta points», сырой ID баффа `<класс>_asc_N`, fallback на character_id; описать награду меты по смыслу; проверить баннер и экран поражения; тест на фактический текст без `asc_`/`Meta points` |
