...
| [design_codex_elite_boss_sprite_resolution_upscale_task.md](../tasks/design_codex_elite_boss_sprite_resolution_upscale_task.md) | Design (Codex) → Claude-Designer | in_progress | Jira: SCRUM-135; dispatched Design `019eabf1-6d54-7561-8af9-ce25cdf483a9` 2026-06-12. Анти-мыло: 4 элитки + 2 босса 256→512px (поза 1:1), пруф `docs/design/previews/elite_boss_blur_proof.png` |
