...
| [backend_survivability_rebalance_vampirism_nerf_weighted_levelup_task.md](../tasks/backend_survivability_rebalance_vampirism_nerf_weighted_levelup_task.md) | Back-end (баланс, Claude) | in_progress | Jira: SCRUM-149; dispatched Back-end `019eabd9-780b-78a2-9f4b-e7203d659ef2` 2026-06-12. Нерф вампиризма, усилить реген/броню/уклонение, пересмотр атрибут×класс (единый источник с SCRUM-146), weighted level-up; balance harness до/после, DPS ±10% |
| [backend_victory_screen_player_facing_text_task.md](../tasks/backend_victory_screen_player_facing_text_task.md) | Back-end (UI-текст) | in_progress | Jira: SCRUM-148; dispatched Back-end `019eabd9-780b-78a2-9f4b-e7203d659ef2` 2026-06-12. Экран победы: только пользовательская информация на русском — убрать «Meta points», сырой ID баффа `<класс>_asc_N`, fallback на character_id; описать награду меты по смыслу; проверить баннер и экран поражения; тест на фактический текст без `asc_`/`Meta points` |
| [backend_escape_pause_character_overview_anywhere_task.md](../tasks/backend_escape_pause_character_overview_anywhere_task.md) | Back-end (UI/UX) | in_progress | Jira: SCRUM-146; dispatched Back-end `019eabd9-780b-78a2-9f4b-e7203d659ef2` 2026-06-12. Переосмысление Escape: досье персонажа с выделенными приоритетными атрибутами класса, доступно поверх магазина/level-up/события/награды/route map без поломки их состояния |
