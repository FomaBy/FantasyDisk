...
| [design_integrate_generated_settings_tab_switcher_frame_task.md](../tasks/design_integrate_generated_settings_tab_switcher_frame_task.md) | Designer (Codex) | in_progress | Jira: SCRUM-325. В работе Design/Codex: принять/доработать generated settings tab switcher frame, перенести production PNG в runtime assets, зафиксировать content-zone/safe-area; labels/click zones только в content-zone |
