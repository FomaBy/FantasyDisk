...
| --- | --- | --- | --- |
| [backend_new_bosses_mini_elites_roster_task.md](../tasks/backend_new_bosses_mini_elites_roster_task.md) | Back-end (Claude) | new | Jira: SCRUM-155; 3 новых босса (Костяной Архонт, Матерь Роя, Пепельный Колосс) + 6 видов мини-элиток для свиты Возвышения L7: фазовые паттерны, HazardVfx-телеграфы, data-driven виды, кодекс, ротация боссов из 5; арт — парная design-задача (общий ростер), до готовности — placeholder'ы |
| [design_codex_new_bosses_mini_elites_sprites_task.md](../tasks/design_codex_new_bosses_mini_elites_sprites_task.md) | Design (Codex генерация) → Claude-Designer | new | Jira: SCRUM-156; Спрайты по общему ростеру: 3 босса 512px + 6 мини-элиток, painterly D&D, cutout-нарезка, превью-лист масштаба; handoff-отметка в backend-задаче по готовности |
| [backend_drop_economy_rebalance_task.md](../tasks/backend_drop_economy_rebalance_task.md) | Back-end (баланс, Claude) | new | Jira: SCRUM-153; Дроп по классам целей (жирные ×1.5-2, мини ×3-4, элитки ×6-10, боссы фикс+этап) + согласованное подорожание всего за золото; чистая покупательная способность +10-15%, кривая уровней ±10-15%; не конфликтовать по файлам со SCRUM-149 |
| [backend_music_tavern_ambient_task.md](../tasks/backend_music_tavern_ambient_task.md) | Back-end (Claude, ресёрч+интеграция) | new | Jira: SCRUM-154; Замена музыки на струнный тавернный эмбиент (лютня/арфа/гитара): меню + бой (+опц. босс), только CC0/CC-BY с фиксацией лицензий и атрибуцией, бесшовный луп, нормализация, кроссфейд меню↔бой |
| [backend_settings_volume_slider_ux_task.md](../tasks/backend_settings_volume_slider_ux_task.md) | Back-end (UI) | new | Jira: SCRUM-151; Настройки/Звук: трек слайдера не отрисовывается (виден только грабер), нужен видимый трек с заливкой, клик-по-треку, крупный хват, живое изменение звука, понятный mute; скриншот после правки в build/qa/ |
| [backend_meta_skill_tree_task.md](../tasks/backend_meta_skill_tree_task.md) | Back-end (Claude, архитектура+баланс+UI) | new | Jira: SCRUM-150; Мета-прогрессия: общее древо умений ~44 очка, 4 ветви (Богатство/Знания/Мощь/Стойкость) с capstone'ами, data-driven, экран в главном меню, скиллпоинты из meta_points/побед, полная прокачка ≤ +25-30% силы (harness); синхронизация с SCRUM-149 по rare/выживанию |
| [design_codex_summon_allies_sprites_task.md](../tasks/design_codex_summon_allies_sprites_task.md) | Design (Codex генерация) → Claude-Designer | new | Jira: SCRUM-152; Спрайты ВСЕХ призывных союзников в D&D-каноне (у AllyMinion сейчас вообще нет спрайта): питомцы/стая Друида, эхо Лидерства, гомункул Химика, амп Гитариста как полевой объект; различимость «свой/чужой», превью-лист масштаба, качество не ниже канона персонажей |
...
| [design_codex_ui_dark_fantasy_restyle_task.md](../tasks/design_codex_ui_dark_fantasy_restyle_task.md) | Design (Claude арт-дирекшен/ревью; генерация Codex) → handoff Back-end | blocked | Jira: SCRUM-147; спринт 0.1.4, но НЕ dispatch: ждёт референсы пользователя в docs/design/references/ui_dark_fantasy_2026_06/ (5 листов, сейчас есть только README). Полный рестайл UI в dark fantasy; supersedes SCRUM-111/118 |
