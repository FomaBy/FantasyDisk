...
| [bug_combat_level_up_button_reposition_opaque_task.md](../tasks/bug_combat_level_up_button_reposition_opaque_task.md) | Back-end (UI) | in_progress | Jira: SCRUM-278. Перенести in-combat `LevelUpPlusButton` в правый нижний угол, alpha=1, hover/focus без визуального изменения |
