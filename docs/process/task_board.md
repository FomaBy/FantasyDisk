...
| --- | --- | --- | --- |
| [bug_button_hover_remove_yellow_glow_task.md](../tasks/bug_button_hover_remove_yellow_glow_task.md) | Back-end (UI) | new | UX 0.1.5: переделать hover кнопок — ярче+контрастнее, убрать жёлтое свечение и золотой font_hover_color (все кнопки + focus); связано с SCRUM-273 |
