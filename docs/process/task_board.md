...
| [design_codex_apply_ornate_frame_kit_task.md](../tasks/design_codex_apply_ornate_frame_kit_task.md) | Design → Back-end | in_progress | Jira: SCRUM-274. Active in Design thread `019eabf1-6d54-7561-8af9-ce25cdf483a9` after SCRUM-273; Ornate Dark frame kit slice/9-slice/panel integration |
