...
| [backend_druid_wolf_summon_animation_integrate_task.md](../tasks/backend_druid_wolf_summon_animation_integrate_task.md) | Back-end (анимации) | done | Jira: SCRUM-279. `druid_beast` now uses `AllyMinion/AnimatedBody` with wolf SpriteFrames move/attack/flip; other ally visuals remain static; 6 smoke checks PASS; QA contact in `build/qa/druid_wolf_backend_integration/` |
