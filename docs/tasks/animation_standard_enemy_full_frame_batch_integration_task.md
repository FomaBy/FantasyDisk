...
four additional standard enemies after the already integrated `rift_cutter` pilot:
...
- Register the four standard enemies in `FullFrameAnimationRegistry`.
...
- [ ] Runtime full-frame registry resolves all four `enemy/<id>` entries.
