...
Jira: SCRUM-766
Locked paths: assets/sprites/effects/vfx_weapon_soldier_bayonet.png, docs/design/references/weapon_attack_animations/soldier_bayonet/, docs/design/previews/weapon_attack_animations/soldier_bayonet_contact.png, scenes/SoldierBayonet.tscn, assets/sprites/weapons/soldier_bayonet.png
...
- [ ] `assets/sprites/effects/vfx_weapon_soldier_bayonet.png` обновлен или подтверждён как accepted с новым OpenAI source/evidence.
- [ ] Source, prompt notes/manifest и preview/contact sheet сохранены в task-specific paths.
- [ ] Attack VFX уникально отражает **Штык-стойка**, показывает зону действия и содержит полупрозрачный фоновой силуэт оружия.
