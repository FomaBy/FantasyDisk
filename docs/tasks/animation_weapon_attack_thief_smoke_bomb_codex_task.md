...
Jira: SCRUM-775
Locked paths: assets/sprites/effects/vfx_weapon_thief_smoke_bomb.png, docs/design/references/weapon_attack_animations/thief_smoke_bomb/, docs/design/previews/weapon_attack_animations/thief_smoke_bomb_contact.png, scenes/ThiefSmokeBomb.tscn, assets/sprites/weapons/thief_smoke_bomb.png
...
Source PNG и prompt notes сохранить в `docs/design/references/weapon_attack_animations/thief_smoke_bomb/`. Accepted runtime PNG обновлять только по пути `assets/sprites/effects/vfx_weapon_thief_smoke_bomb.png`, если не создан отдельный backend/runtime handoff.
...
- [ ] `assets/sprites/effects/vfx_weapon_thief_smoke_bomb.png` обновлен или подтверждён как accepted с новым OpenAI source/evidence.
- [ ] Source, prompt notes/manifest и preview/contact sheet сохранены в task-specific paths.
- [ ] Attack VFX уникально отражает **Дымовая Бомба**, показывает зону действия и содержит полупрозрачный фоновой силуэт оружия.
