...
## Образ (арт-дирекция)
Химик: алхимик, яркие неоново-кислотные склянки (зелёный/жёлтый), пузырьки; броско. Без оружия в руках (оружие — отдельно). Прозрачный фон обязателен.
...
## Требования
1. Нарисовать «Химик» v2 в ярком эпичном стиле класса (по опорной), на ПРОЗРАЧНОМ
...
6. Тест: animation+runtime smoke зелёные; на экране «Химик» яркий, прозрачный,
   вдвое крупнее монстра, move/idle плавные. Превью-гиф в build/qa/.
7. CHANGELOG; content_registry.

## Acceptance Criteria
- [ ] «Химик» перерисован v2: ярко/эпично по классу, прозрачный фон (нет белого/каймы/карманов).
