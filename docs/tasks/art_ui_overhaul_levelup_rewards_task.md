...
Статус: done (superseded/closed by PM; covered by SCRUM-338/348)
Приоритет: medium
Роль: Designer (Codex)
Версия: 0.1.5
Создано: 2026-06-14
...
Кластер «Повышение уровня и награды» инициативы «UI Overhaul: D&D + Dark Fantasy Dragon» (0.2.0).
Экран выбора усилений, награды, артефакты элиток, выбор оружия. Карточки выбора — контент в content-зоне рамок.

Экраны кластера (scripts/ui_screens.gd): _show_level_up_screen (2285), _show_reward_screen (2274), _show_elite_artifact_reward (2368), _show_weapon_select (2158).
...
## Files / Assets / IDs
- scripts/ui_screens.gd (экраны кластера: _show_level_up_screen (2285), _show_reward_screen (2274), _show_elite_artifact_reward (2368), _show_weapon_select (2158))
- assets/ (игровые ассеты) + docs/design/references/ (исходники)
- tests/runtime_smoke_test.gd

## Acceptance Criteria
- [ ] Все экраны кластера «Повышение уровня и награды» в едином стиле D&D + Dark Fantasy Dragon (новым скиллом, прозрачный фон).
...
SCRUM-328 закрыт в Jira как дубль/широкий кластер, покрытый более конкретными
