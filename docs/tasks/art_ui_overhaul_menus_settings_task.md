# ART: UI Overhaul (Меню и настройки) — D&D + Dark Fantasy Dragon, новым скиллом

Статус: done (superseded/closed by PM; covered by SCRUM-391/341/316)
Приоритет: medium
Роль: Designer (Codex)
Версия: 0.1.5
Создано: 2026-06-14
...
Кластер «Меню и настройки» инициативы «UI Overhaul: D&D + Dark Fantasy Dragon» (0.2.0).
Главное меню, настройки (все вкладки + переключатель вкладок — реф settings_tab_switcher_frame), «Что нового», диалог конфликта бинда, диалог подтверждения выхода (SCRUM-319).
...
## Files / Assets / IDs
- scripts/ui_screens.gd (экраны кластера: _show_main_menu (94), _show_settings_menu (1551), _show_patch_notes_screen (1125), _show_rebind_conflict (4006), _show_quit_confirmation_dialog (218))
- assets/ (игровые ассеты) + docs/design/references/ (исходники)
- tests/runtime_smoke_test.gd

## Acceptance Criteria
- [ ] Все экраны кластера «Меню и настройки» в едином стиле D&D + Dark Fantasy Dragon (новым скиллом, прозрачный фон).
...
Широкий UI-Overhaul кластер закрыт как покрытый более конкретными задачами: SCRUM-391 (рестайл настроек) + SCRUM-341 (вкладки) + SCRUM-316 (фон меню). Дубль не нужен.

## QA-Вердикт (2026-06-27)

Статус: PASSED (administrative PM closure)

SCRUM-329 закрыт в Jira как дубль/широкий кластер, покрытый более конкретными
