...
UI (dark fantasy), старые контекстные киты НЕ интегрируются. Эта задача не
выполняется; интеграция нового стиля придёт handoff'ом из
`docs/tasks/design_codex_ui_dark_fantasy_restyle_task.md`.
