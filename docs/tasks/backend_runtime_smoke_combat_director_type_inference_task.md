...
runtime_smoke + все 6 сьютов зелёные на чистом дереве (многократный прогон в QA-сессии).
Ошибка type-inference была промежуточным мид-эдитом параллельной работы, не реальным
дефектом — подтверждаю закрытие как transient. Багов нет.
