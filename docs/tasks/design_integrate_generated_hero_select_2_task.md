...
```text
Wide rectangular DOSSIER description panel D&D Dark Fantasy Dragon UI frame, aged dark forged metal with muted gold trim, ruby gem accents, claw-notched corners, subtle dragon scale texture, ornate but restrained. Single isolated frame asset, FULLY TRANSPARENT empty interior content zone (alpha), ornament ONLY on the border, no background, no text, no characters. Clean 9-slice friendly border, crisp, centered.
```
