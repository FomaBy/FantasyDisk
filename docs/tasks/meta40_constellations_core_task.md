...
- 2026-07-02 (заход 2, после session-limit первого исполнителя — с нуля):
  - **Ядро** (`f620eee1`): `meta_progression.gd` переведён на схему 5 — валюты
  ...
  - **Тесты** (`19ff6559`, `690e27d7`): три locked-теста переписаны под ядро;
...
- Коммиты в origin/dev: `f620eee1` (ядро), `19ff6559` (тесты+док),
  `690e27d7` (лестница эмблем с авто-челленджем), `c72530f5` (размер Атласа
  25/60), `4f116a1b` (базлайн атлас-вклада), финальный — CHANGELOG+эта спека.
