...
Thread: n/a
Исполнитель: Codex
Locked paths: `scripts/player.gd` (движение+вибрация), `tests/gamepad_player_movement_test.gd`
Версия: 0.1.8
Приоритет: P1
Создано: 2026-07-02
...
## Acceptance Criteria
- [ ] Стик двигает игрока во все стороны с плавными диагоналями; deadzone 0.25;
      наклон стика на 50% даёт пропорционально меньшую скорость, макс. скорость
      равна клавиатурной.
- [ ] D-pad двигает игрока как WASD (полная скорость).
- [ ] WASD/стрелки работают ровно как до задачи (smoke без регрессий).
- [ ] Вибрация на урон/смерть/ульту, отключается настройкой gamepad_vibration,
      headless/без геймпада не падает.
- [ ] Повторная инициализация экшенов не создаёт дублей событий.
- [ ] Тест gamepad_player_movement_test.gd зелёный (2 прогона), существующие
