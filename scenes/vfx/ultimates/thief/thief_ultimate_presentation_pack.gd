...
const WEAPONS := {
	COIN_POUCH: {
		...
		"pivot": {"x": 0.5, "y": 0.5},
		"timing": {"windup": 0.0, "release": 0.70, "active": 1.10, "recovery": 2.25, "cancel": 3.05},
	...
	SHADOW_CLOAK: {
		...
		"pivot": {"x": 0.5, "y": 0.5},
		"timing": {"windup": 0.0, "release": 0.82, "active": 1.22, "recovery": 2.35, "cancel": 3.20},
	...
	SMOKE_BOMB: {
		...
		"pivot": {"x": 0.5, "y": 0.5},
		"timing": {"windup": 0.0, "release": 0.94, "active": 1.34, "recovery": 2.48, "cancel": 3.42},
