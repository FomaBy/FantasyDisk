...
const CHARACTER_PLAYSTYLE := {
	...
	"assassin": "Танец на лезвии: чакрамы режут дважды — туда и обратно. Криты решают, неподвижность убивает.",
	"ranger": "Один болт — одна история: длинная линия, точный пробой, холодная голова на дистанции.",
	"doctor": "Лечит то, что ранит других: каждое брошенное зелье жжет врагов и штопает тебя.",
	"chemist": "Земля после него не родит: взрывы, кислотные облака и яд, который доделывает работу.",
	"knight": "Стена с копьем: держи строй, поглощай удары, бей редко — но в самое сердце.",
	"druid": "Лес воюет за него: стая зверей растет с Лидерством, а друид лишь указывает цель.",
}
