...
# SCRUM-614: окно эффекта расширено до 1.35с, чтобы момент роста читался как
# весомый всплеск. Текст теперь живёт в LevelUpToastFrame, чтобы не было двух плашек.
...
func _build_visual() -> void:
	# Текстурный праздничный бурст вокруг персонажа: золотая вспышка +
	# расходящееся кольцо + радиальные искры. Плашка с текстом живёт в HUD toast.
	...
	_play(flash, ring, sparks)


func _play(flash: Sprite2D, ring: Sprite2D, sparks: Array[Sprite2D]) -> void:
