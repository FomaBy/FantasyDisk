...
const CLASS_BUDGET_PROFILES := {
	...
	"soldier": {"profile": "balanced", "survival": "steady", "damage_budget": 0.72, "solo_target": 1.00, "aoe_target": 1.00},  # FAN-1031 v8-микротрим: total 1.17 (чуть над коридором ±15%). db 0.76→0.72 — ещё один малый шаг uniform per-hit cut всех трёх (unclamped). def 1.22 = steady (in-profile, не трогаем). Калибровать по v9. [v7-история: total 1.19, solo 1.42 bayonet-driven; db 0.82→0.76.]
