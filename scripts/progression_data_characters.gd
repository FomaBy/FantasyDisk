...
const CHARACTER_CONFIGS := {
	...
	"sniper": {
		...
		"strengths": "урон растёт с дистанцией (до +60%), огромная дальность, тяжелые точные выстрелы, криты, фокус элит.",
		"weaknesses": "вплотную урон лишь обычный — толпу в упор держит только веер.",
	...
	"robot": {
		...
		"strengths": "встроенный игнор 20% входящего урона, огромная живучесть, стягивание и построение толпы, контроль зон.",
	...
	"ranger": {
		...
		"strengths": "отброс каждым попаданием лука («Сторожевой лук»), расщепляющийся болт, дальний пробивающий конус, вечные капканы с параличом и кровотечением.",
