...
const ARTIFACTS := [
	...
	{"id": "spore_capacitor", "title": "Споровый конденсатор", "tier": 2, "cost": 55, "class_affinity": ["biologist"], "requires_ascension": 5, "description": "Кольца Споровой линзы замедляют врагов на 25%; +10% магического урона.", "mods": {"spore_slow_power": 0.25, "magic_damage_multiplier": 1.10}},
	{"id": "sample_chain", "title": "Цепь образцов", "tier": 3, "cost": 95, "class_affinity": ["biologist"], "requires_ascension": 5, "description": "Инъектор бьёт всех врагов на пути луча (70%), финальный анализ шире (+25%).", "mods": {"sample_beam_full_damage": 1.0}},
	{"id": "symbiote_sheath", "title": "Симбиотическая оболочка", "tier": 2, "cost": 55, "class_affinity": ["biologist"], "requires_ascension": 5, "description": "Семя бьёт при попадании на 35% сильнее, сеть тикает на 2 тика дольше.", "mods": {"symbiote_impact_bonus": 0.35, "symbiote_dot_extra_ticks": 2.0}},
	...
	# Thief — Уловка и темп:
	{"id": "lucky_coin", "title": "Счастливая монета", "tier": 2, "cost": 55, "class_affinity": ["thief"], "requires_ascension": 5, "description": "Монета скачет на 2 прыжка дольше и крадёт +1 золото за атаку.", "mods": {"coin_extra_bounces": 2.0, "coin_steal_bonus": 1.0}},
	...
	{"id": "paralyzing_blade", "title": "Парализующее лезвие", "tier": 3, "cost": 95, "class_affinity": ["thief"], "requires_ascension": 5, "description": "Удар Плаща Захода коротко парализует задетых врагов (0.7с).", "mods": {"backstab_root_duration": 0.7}},
	{"id": "smoke_cache", "title": "Дымный тайник", "tier": 2, "cost": 55, "class_affinity": ["thief"], "requires_ascension": 5, "description": "Дымовая завеса на 40% дольше и даёт ещё +12% уклонения.", "mods": {"smoke_duration_mult": 0.40, "smoke_dodge_bonus": 0.12}},
	...
	{"id": "turret_magazine", "title": "Магазин турели", "tier": 2, "cost": 55, "class_affinity": ["engineer"], "requires_ascension": 5, "description": "Турели уходят, лишь расстреляв магазин (14 выстрелов), и получают +6 выстрелов.", "mods": {"sentry_magazine_bonus": 6.0}},
	{"id": "drone_gyroscope", "title": "Гироскоп дрона", "tier": 2, "cost": 55, "class_affinity": ["engineer"], "requires_ascension": 5, "description": "+1 цель цепи дрона; устройства работают на 12% чаще.", "mods": {"drone_extra_links": 1.0, "device_attack_speed_bonus": 0.12}},
	...
	{"id": "reliquary_salvo", "title": "Реликварный залп", "tier": 3, "cost": 95, "class_affinity": ["priest"], "requires_ascension": 5, "description": "Реликварий забывает лечение: залпы чаще (−25% интервала), взрыв сильнее (+20%).", "mods": {"reliquary_barrage_mode": 1.0}},
	...
	{"id": "twin_bell", "title": "Двойной колокол", "tier": 3, "cost": 95, "class_affinity": ["priest"], "requires_ascension": 5, "description": "Колокол взрывается у цели и у Жреца (по 55%), без двойного урона по одному врагу.", "mods": {"chime_twin_toll": 1.0}},
	...
	# Soldier — Тактическая линия огня:
	...
	{"id": "arquebus_shrapnel", "title": "Шрапнель аркебузы", "tier": 2, "cost": 55, "class_affinity": ["soldier"], "requires_ascension": 5, "description": "Коридор подавления шире (+25%), соседям основной цели прилетает больше.", "mods": {"arquebus_shrapnel_bonus": 1.0}},
	...
	{"id": "bayonet_trigger", "title": "Спуск штыка", "tier": 2, "cost": 55, "class_affinity": ["soldier"], "requires_ascension": 5, "description": "При уколе штыка 35% шанс пули по линии (дальность 420, 70% урона).", "mods": {"bayonet_shot_chance": 0.35}},
	...
	{"id": "volatile_dust", "title": "Летучая пыль", "tier": 2, "cost": 55, "class_affinity": ["chemist"], "requires_ascension": 5, "description": "Взрывная пыль без облака: касты на 22% быстрее, прямой взрыв +25%.", "mods": {"volatile_powder_mode": 1.0}},
	{"id": "acid_catalyst", "title": "Кислотный катализатор", "tier": 3, "cost": 95, "class_affinity": ["chemist"], "requires_ascension": 5, "description": "Контакт с кислотной лужей вешает перманентные стаки едкого DoT (до 5).", "mods": {"acid_charge_stacks": 1.0}},
	...
	{"id": "tank_homunculus", "title": "Гомункул-танк", "tier": 3, "cost": 95, "class_affinity": ["chemist"], "requires_ascension": 5, "description": "Гомункул-здоровяк: +60% HP и провокация; +25% силы гомункулов.", "mods": {"homunculus_taunt": 1.0, "homunculus_power_mult": 0.25}},
	...
	# Elementalist — Стихийная формула:
	{"id": "fourth_ring", "title": "Четвертое кольцо", "tier": 3, "cost": 95, "class_affinity": ["elementalist"], "requires_ascension": 5, "description": "К трём стихиям приходит земля: квадратная зона с физическим ударом, DoT и отбросом.", "mods": {"elemental_orb_extra_count": 1.0, "earth_orb_mode": 1.0}},
	{"id": "prismatic_cross", "title": "Призматический крест", "tier": 3, "cost": 95, "class_affinity": ["elementalist"], "requires_ascension": 5, "description": "Крест призмы пробивает карту насквозь (дальняя часть 60%); +20% радиуса.", "mods": {"prism_cross_pierce": 1.0, "prism_rift_radius_mult": 0.20}},
	{"id": "meteor_heart", "title": "Сердце метеора", "tier": 2, "cost": 55, "class_affinity": ["elementalist"], "requires_ascension": 5, "description": "Метеор реже (+45% интервала), но центральный удар +70%, воронка догорает DoT.", "mods": {"meteor_heart_mode": 1.0}},
