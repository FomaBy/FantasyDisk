...
const LEVEL_UP_REWARDS := [
	...
	{"id": "aoe_radius_up", "attr": "aoe_radius", "title": "+Радиус области", "description": "+15% к конусам и радиусам атак.", "kind": "upgrade", "mods": {"aoe_radius_multiplier": 1.15, "range_multiplier": 1.08}},
	...
	{"id": "magic_focus_up", "attr": "magic_focus", "title": "+Магический фокус", "description": "+14% к магическому/звуковому урону или зачарованию оружия.", "kind": "upgrade", "mods": {"damage_multiplier": 1.14}},
	...
	{"id": "aura_radius_up", "attr": "aura_radius", "title": "+Радиус ауры", "description": "+55 к радиусу ауры. Классы без аур получают более сильный ближний боевой клич.", "kind": "upgrade", "mods": {"aura_radius_flat": 55.0}},
