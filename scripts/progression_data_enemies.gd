...
const MINI_ELITE_KINDS := [
	...
	{"id": "mini_siege_rammer", "title": "Осадный Таран", "scene": "armored", "behavior": "iron_bastion", "hp_mult": 0.92, "speed_mult": 0.78, "damage_mult": 1.35, "tint": [0.96, 0.74, 0.42], "desc": "Бронированный таран: самый толстый из мини и тяжёлая ударная волна, но медлителен."},
