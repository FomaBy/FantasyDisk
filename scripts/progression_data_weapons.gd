...
const SOLDIER_WEAPONS := {
	...
	"soldier_grenade": {
		...
		"description": "Бросок с фитилем: граната летит и лежит без урона, затем видимая зона взрывается с плавным падением к краю.",
		"scene_path": "res://scenes/SoldierGrenade.tscn",
		"attack_mode": "grenade_cook", "damage_parameter": "damage",
		"damage_multiplier": 1.16, "fire_interval": 1.58,
		"attack_range": 520.0, "aoe_radius": 175.0,
		"projectile_speed": 560.0, "grenade_delay": 0.58,
