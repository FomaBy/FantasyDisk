...
const STAT_DEFINITIONS := {
	...
	INTELLIGENCE: {
		...
		"type": "base",
		"description": "Зарезервирован под магический урон, опыт и магические эффекты.",
		"formula": "Базовая характеристика персонажа + награды характеристик.",
		"influences": "Будущие магические параметры.",
		"format": "plain",
	},
	PERCEPTION: {
		"name_ru": "Восприятие",
	...
	ENERGY: {
		...
		"name_en": "Energy",
		"type": "base",
		"description": "Зарезервирована под ресурс, регенерацию, вампиризм и расход маны.",
		"formula": "Базовая характеристика персонажа + награды характеристик.",
		"influences": "Будущие ресурсные и вампирические параметры.",
		"format": "plain",
	},
	KNOWLEDGE: {
		"name_ru": "Знание",
	...
	LEADERSHIP: {
		...
		"formula": "Базовая характеристика персонажа + награды характеристик.",
		"influences": "Summon Amount и будущие aura/summon параметры.",
		"format": "plain",
	},
	"damage": {
		"name_ru": "Урон",
	...
	"absorb": {
		...
		"name_en": "Absorb",
		"type": "derived",
		"description": "Щит/поглощение перед основным уроном. Пока не подключено.",
		"formula": "Default + Addition. Формула пока не подключена к бою.",
		"influences": "Будущие щиты, предметы и защитные эффекты.",
		"format": "decimal",
		"default_value": 0.0,
	},
	"health_point": {
	...
	"knockback_distance": {
		...
		"formula": "(Default + Addition) * Endurance / 2. Формула пока не подключена к бою.",
	...
	"regeneration": {
		...
		"formula": "(Default + Addition) * Knowledge / 5. Формула пока не подключена к бою.",
	...
	"vampiric_amount": {
		...
		"formula": "Default + Addition + Current Damage / 2. Формула пока не подключена к бою.",
	...
	"ultimate_multiplier": {
		...
		"formula": "Default + Addition. Формула пока не подключена.",
