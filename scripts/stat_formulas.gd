...
const STAT_DEFINITIONS := {
	...
	"damage": {
		...
		"influences": "Strength, оружие и награды на общий Damage. Magic Damage и Sound Damage не усиливают физический урон.",
		"format": "decimal",
	},
	"magic_damage": {
		...
		"influences": "Intelligence, оружие, общий Damage и награды на Magic Focus. Не усиливает physical/sound каналы.",
		"format": "decimal",
		"default_value": 0.0,
	},
	"sound_wave_damage": {
		...
		"formula": "(Perception + Energy) * weapon * универсальный урон * Sound modifiers.",
		"influences": "Perception, Energy, оружие и отдельные sound-модификаторы. Не усиливает physical/magic каналы.",
		"format": "decimal",
		"default_value": 0.0,
	},
	"crit_chance": {
