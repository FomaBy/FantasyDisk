...
func _show_feedback_overlay(screenshot: Image = null) -> void:
	...
	privacy_frame.add_theme_stylebox_override("panel", _atlas_chip_style(0.92, 12.0))
	...
	var privacy_config := _feedback_privacy_configuration()
	...
	var apply_feedback_layout := func() -> void:
		...
		panel.add_theme_stylebox_override(
			"panel", _overhaul_2k_frame_style("fb_panel", panel_size))
	...
	send_button.pressed.connect(func() -> void:
		...
		var request_id := int(reporter.call(
			"submit_report", text_edit.text, submitted_screenshot, _feedback_metadata(),
