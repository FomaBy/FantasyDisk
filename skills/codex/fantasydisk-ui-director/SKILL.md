...
4. If PixelLab MCP credentials, model access, exports, or generation fail, mark the task blocked or create the correct handoff. Do not silently replace the PixelLab-generated mockup with a hand-drawn or different-model substitute.
