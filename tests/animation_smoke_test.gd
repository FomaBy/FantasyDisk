...
func _test_player_animation() -> void:
	...
	for sheet_character_id in accepted_character_spriteframes.keys():
		...
		if sheet_character_id == "assassin" or sheet_character_id == "berserk" or sheet_character_id == "chemist" or sheet_character_id == "dark_mage" or sheet_character_id == "doctor" or sheet_character_id == "druid" or sheet_character_id == "elementalist" or sheet_character_id == "engineer" or sheet_character_id == "guitarist" or sheet_character_id == "knight" or sheet_character_id == "priest" or sheet_character_id == "robot" or sheet_character_id == "sniper" or sheet_character_id == "soldier" or sheet_character_id == "thief":
			var v2_label := "SCRUM-420"
			if sheet_character_id == "assassin" or sheet_character_id == "berserk" or sheet_character_id == "dark_mage" or sheet_character_id == "druid" or sheet_character_id == "elementalist" or sheet_character_id == "engineer" or sheet_character_id == "guitarist" or sheet_character_id == "robot" or sheet_character_id == "sniper" or sheet_character_id == "soldier" or sheet_character_id == "thief":
			...
			if sheet_character_id == "assassin" or sheet_character_id == "elementalist" or sheet_character_id == "robot" or sheet_character_id == "soldier" or sheet_character_id == "thief":
				...
				if body.sprite_frames.get_frame_count("idle") != 1 or body.sprite_frames.get_frame_count("walk") != 6 or body.sprite_frames.get_frame_count("move") != 6:
					...
					return
				continue
			if sheet_character_id == "berserk" or sheet_character_id == "druid" or sheet_character_id == "engineer" or sheet_character_id == "sniper":
				for direction_name in ["south", "south_east", "east", "north_east", "north", "north_west", "west", "south_west"]:
					if not body.sprite_frames.has_animation("walk_%s" % direction_name) or body.sprite_frames.get_frame_count("walk_%s" % direction_name) != 6:
						_fail("Expected %s PixelLab directional SpriteFrames to expose 6-frame walk_%s." % [sheet_character_id, direction_name])
						return
			...
			if sheet_character_id == "doctor":
				for direction_name in ["south", "south_east", "east", "north_east", "north", "north_west", "west", "south_west"]:
					if not body.sprite_frames.has_animation("walk_%s" % direction_name) or body.sprite_frames.get_frame_count("walk_%s" % direction_name) != 6:
						_fail("Expected Doctor PixelLab directional SpriteFrames to expose 6-frame walk_%s." % direction_name)
						return
				if body.sprite_frames.get_frame_count("idle") != 1 or body.sprite_frames.get_frame_count("walk") != 6 or body.sprite_frames.get_frame_count("move") != 6:
			...
			if sheet_character_id == "priest":
				...
				if body.sprite_frames.get_frame_count("idle") != 1 or body.sprite_frames.get_frame_count("walk") != 6 or body.sprite_frames.get_frame_count("move") != 6:
					...
					return
				continue
			if sheet_character_id == "chemist":
				for direction_name in ["south", "south_east", "east", "north_east", "north", "north_west", "west", "south_west"]:
					if not body.sprite_frames.has_animation("walk_%s" % direction_name) or body.sprite_frames.get_frame_count("walk_%s" % direction_name) != 6:
						_fail("Expected Chemist PixelLab directional SpriteFrames to expose 6-frame walk_%s." % direction_name)
						return
				if body.sprite_frames.get_frame_count("idle") != 1 or body.sprite_frames.get_frame_count("walk") != 6 or body.sprite_frames.get_frame_count("move") != 6:
					_fail("Expected Chemist PixelLab fallback idle/walk/move frame counts to be 1/6/6.")
					return
				continue
			if sheet_character_id == "dark_mage":
				for direction_name in ["south", "south_east", "east", "north_east", "north", "north_west", "west", "south_west"]:
					if not body.sprite_frames.has_animation("walk_%s" % direction_name) or body.sprite_frames.get_frame_count("walk_%s" % direction_name) != 6:
						_fail("Expected Dark Mage PixelLab directional SpriteFrames to expose 6-frame walk_%s." % direction_name)
						return
				if body.sprite_frames.get_frame_count("idle") != 1 or body.sprite_frames.get_frame_count("walk") != 6 or body.sprite_frames.get_frame_count("move") != 6:
					_fail("Expected Dark Mage PixelLab fallback idle/walk/move frame counts to be 1/6/6.")
					return
				continue
