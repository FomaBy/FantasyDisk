...
const DEFENSIVE_FIXTURES := [
	...
	"res://tests/balance/knight/knight_kit_test.gd",
	...
	"res://tests/balance/priest/priest_kit_test.gd",
	"res://tests/balance/priest/priest_sustain_softcap_test.gd",
	"res://tests/balance/robot/robot_kit_test.gd",
	"res://tests/runtime_smoke_combat_test.gd",
	"res://tests/runtime_smoke_test.gd",
	"res://tests/runtime_smoke_triggered_artifacts_test.gd",
	"res://tests/balance/thief/thief_kit_test.gd",
