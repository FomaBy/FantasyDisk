...
func _initialize() -> void:
	...
	for character_id in ids:
		...
		if character_id == "berserk" or character_id == "chemist" or character_id == "dark_mage" or character_id == "doctor" or character_id == "druid" or character_id == "engineer" or character_id == "guitarist" or character_id == "knight" or character_id == "priest" or character_id == "sniper":
