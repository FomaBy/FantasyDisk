...
const EXPECTED_SPRITES := {
	...
	"biologist": "res://assets/sprites/characters/full_frame/biologist_pixellab/biologist_idle_south.png",
	...
	"ranger": "res://assets/sprites/characters/full_frame/ranger_pixellab/ranger_idle_south.png",
...
func _initialize() -> void:
	...
	for character_id in ids:
		...
		if character_id == "assassin" or character_id == "berserk" or character_id == "biologist" or character_id == "chemist" or character_id == "dark_mage" or character_id == "doctor" or character_id == "druid" or character_id == "elementalist" or character_id == "engineer" or character_id == "guitarist" or character_id == "knight" or character_id == "priest" or character_id == "ranger" or character_id == "robot" or character_id == "sniper" or character_id == "soldier" or character_id == "thief":
