...
func _is_evidence_only_path(path: String) -> bool:
	return path == CAPTURE_MANIFEST_PATH.trim_prefix("res://") \
		or path == "docs/design/references/weapon_ultimates/assassin/certification_readability_report.md" \
		or path == CLASS_MANIFEST_PATH.trim_prefix("res://") \
		or path.begins_with("docs/design/reference-assets-lfs/ultimate-certification/assassin/")
