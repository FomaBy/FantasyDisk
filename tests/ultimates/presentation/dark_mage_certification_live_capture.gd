...
## Windowed, deterministic evidence renderer for FAN-3938.
##
## Each sheet contains the three canonical Dark Mage ultimate scenes in four
...
const VICTIM_IMPACT_INTEGRATION_SHA := "d192be10bbe52dd89971cab0acc66eb92ccab37f"
const VICTIM_IMPACT_INTEGRATION_TREE := "e4a423855ffab4e8c83a2e5255fef4e65f4cf5cf"
...
const EFFECT_SCENE_PATHS := {
	"dark_book": "res://scripts/ultimates/classes/dark_mage/dark_book.tscn",
	"cursed_skull": "res://scripts/ultimates/classes/dark_mage/cursed_skull.tscn",
	"dark_wand": "res://scripts/ultimates/classes/dark_mage/dark_wand.tscn",
}
const VICTIM_FRAMES := {
	"dark_book": preload("res://assets/sprites/effects/dark_mage/dark_book/dark_book_spriteframes.tres"),
	"cursed_skull": preload("res://assets/sprites/effects/dark_mage/cursed_skull/cursed_skull_spriteframes.tres"),
	"dark_wand": preload("res://assets/sprites/effects/dark_mage/dark_wand/dark_wand_spriteframes.tres"),
}
const CAPTURES := [
	{"id": "648p", "path": "res://docs/design/reference-assets-lfs/ultimate-certification/dark_mage/dark_mage_certification_648p.png", "size": Vector2i(1152, 648)},
	{"id": "720p", "path": "res://docs/design/reference-assets-lfs/ultimate-certification/dark_mage/dark_mage_certification_720p.png", "size": Vector2i(1280, 720)},
	{"id": "1080p", "path": "res://docs/design/reference-assets-lfs/ultimate-certification/dark_mage/dark_mage_certification_1080p.png", "size": Vector2i(1920, 1080)},
	{"id": "2k", "path": "res://docs/design/reference-assets-lfs/ultimate-certification/dark_mage/dark_mage_certification_2k.png", "size": Vector2i(2560, 1440)},
]
const MODE_SPECS := [
	{
...
func _initialize() -> void:
	if DisplayServer.get_name() == "headless":
		print("FAN-3938 Dark Mage four-viewport capture skipped (headless); run windowed for PNG evidence.")
		quit(0)
		return
	for raw_capture in CAPTURES:
		...
		if result != OK:
			push_error("FAN-3938 Dark Mage capture failed: %s" % error_string(result))
			quit(1)
			return
	quit(0)
...
func _capture_sheet(capture: Dictionary) -> int:
	...
	await process_frame
	if result == OK:
		print("FAN-3938 Dark Mage four-viewport capture saved: %s" % output)
	return result
...
func _make_sheet(size: Vector2i) -> Node2D:
	...
	heading.text = "DARK MAGE ULTIMATES — LIVE VICTIM-IMPACT CAPTURE MATRIX"
...
func _add_live_timeline(host: Node2D, rect: Rect2, weapon_id: String, mode: Dictionary, registry) -> void:
	...
	scene.call("begin", {}, 0)
	scene.call("advance", float(mode.get("timeline_seconds", 1.10)))
