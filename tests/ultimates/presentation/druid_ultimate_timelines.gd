...
const PACKS := [
	{
		...
		"required_nodes": ["AmuletSigil", "HuntTrails", "Pack/BeastNorth", "Pack/BeastSouthWest"],
	},
	{
		...
		"required_nodes": ["Roots/RootNorth", "Roots/RootWest", "BrambleWalls/WallEast", "ThornCrowns/CrownNorth"],
	},
	{
		...
		"required_nodes": ["TotemWings", "FlockVortex/OuterSpiral", "FlockVortex/InnerSpiral", "MarkedTargets/MarkOne", "DiveStreaks/DiveOne"],
	},
]
const CAPTURES := [
	{"name": "648p", "path": "res://docs/design/references/weapon_ultimates/druid/druid_ultimate_timelines_648p.png", "size": Vector2i(1152, 648)},
	{"name": "720p", "path": "res://docs/design/references/weapon_ultimates/druid/druid_ultimate_timelines_720p.png", "size": Vector2i(1280, 720)},
	{"name": "1080p", "path": "res://docs/design/references/weapon_ultimates/druid/druid_ultimate_timelines_1080p.png", "size": Vector2i(1920, 1080)},
	{"name": "2k", "path": "res://docs/design/references/weapon_ultimates/druid/druid_ultimate_timelines_2k.png", "size": Vector2i(2560, 1440)},
]
...
func _initialize() -> void:
	...
	if not errors.is_empty():
		_finish(errors)
		return
	print("Druid ultimate timelines passed (three distinct scenes, frozen phases, lifecycle, evidence, and crowd budgets).")
	quit(0)
