...
const SCENES := {
	...
	"priest_chime": preload("res://scenes/vfx/ultimates/priest/PriestChimeThreeBellsOfDawn.tscn"),
}
const PACKS := [
	{
		...
		"time": 5.9,
		"title": "RELIQUARY — SANCTUM JUDGMENT / rings",
		"position": Vector2(0.18, 0.54),
		"color": Color(1.0, 0.84, 0.5),
		"required_nodes": ["Shrine", "RingJudgment", "RingSanctify", "RingWard", "Pillar"],
	},
	{
		"weapon_id": "priest_censer",
		"scene": preload("res://scenes/vfx/ultimates/priest/PriestCenserUnbreakableVow.tscn"),
		"time": 6.55,
		"title": "CENSER — UNBREAKABLE VOW / orbit ward",
		"position": Vector2(0.5, 0.54),
		"color": Color(0.95, 0.65, 0.3),
		"required_nodes": ["Orbit/Censer", "Orbit/Chain", "WardSmoke", "Beads/BeadCrown", "SlamWave"],
	},
	{
		"weapon_id": "priest_chime",
		"scene": preload("res://scenes/vfx/ultimates/priest/PriestChimeThreeBellsOfDawn.tscn"),
		"time": 4.5,
		"title": "CHIME — THREE BELLS OF DAWN / tolls",
		"position": Vector2(0.82, 0.54),
		"color": Color(0.8, 0.9, 1.0),
		"required_nodes": ["Bell", "TollSilver", "TollGold", "TollDawn", "DawnGuard"],
	},
]
const CAPTURES := [
	{"name": "648p", "path": "res://docs/design/references/weapon_ultimates/priest/priest_ultimate_timelines_648p.png", "size": Vector2i(1152, 648)},
	{"name": "720p", "path": "res://docs/design/references/weapon_ultimates/priest/priest_ultimate_timelines_720p.png", "size": Vector2i(1280, 720)},
	{"name": "1080p", "path": "res://docs/design/references/weapon_ultimates/priest/priest_ultimate_timelines_1080p.png", "size": Vector2i(1920, 1080)},
	{"name": "2k", "path": "res://docs/design/references/weapon_ultimates/priest/priest_ultimate_timelines_2k.png", "size": Vector2i(2560, 1440)},
]
...
const SHEET_TITLE := "PRIEST WEAPON ULTIMATES — DISTINCT PRESENTATION TIMELINES"
...
func _initialize() -> void:
	...
	if not errors.is_empty():
		_finish(errors)
		return
	_expect(str(manifest.get("class_id", "")) == "priest", "manifest must be class-local to Priest", errors)
...
func _finish(errors: Array[String]) -> void:
	for error in errors:
		push_error("Priest ultimate timeline: %s" % error)
	quit(1)
