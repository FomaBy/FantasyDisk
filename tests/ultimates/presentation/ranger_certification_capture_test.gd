...
## validators; the renderer ranger_certification_live_capture.gd preloads it
...
const MANIFEST_PATH := "res://docs/design/references/weapon_ultimates/ranger/certification_capture_manifest.json"
const READABILITY_REPORT := "docs/design/references/weapon_ultimates/ranger/certification_readability_report.md"
const CLASS_MANIFEST_PATH := "res://docs/design/references/weapon_ultimates/ranger/manifest.json"
...
const CAPTURE_COMMAND := "FSD_GODOT_EXCLUSIVE=1 python3 tools/godot_gate.py --path . --fixed-fps 60 --disable-vsync --script res://tests/ultimates/presentation/ranger_certification_live_capture.gd"
