...
## The grenade's payoff runs on the executor clock past the 3.5 s phase
## envelope: first impact 4.7 s, chain every 0.3 s, crater ticks from 6.9 s,
## lifetime 8.4 s. `detonation` samples the chain mid-way, `crater` the
## burning column, `final` the fading column just before the executor
## completes and releases the presentation at 8.4 s.
const WEAPONS := [
	{"weapon_id": "soldier_rifle", "scene_node": "SoldierRifleSuppressiveOrder", "label": "RIFLE", "swatch": Color(0.82, 0.96, 0.62), "payoff_beats": {}},
	{"weapon_id": "soldier_grenade", "scene_node": "SoldierGrenadeSevenSeconds", "label": "GRENADE", "swatch": Color(1.0, 0.62, 0.24), "payoff_beats": {"detonation": 5.6, "crater": 7.15, "final": 8.2}},
	{"weapon_id": "soldier_bayonet", "scene_node": "SoldierBayonetLastCharge", "label": "BAYONET", "swatch": Color(0.74, 0.86, 1.0), "payoff_beats": {}},
]
