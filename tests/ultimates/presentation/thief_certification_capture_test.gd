...
## the validators; the renderer thief_certification_live_capture.gd preloads
...
const CAPTURE_COMMAND := "python3 tools/godot_gate.py --path . --fixed-fps 60 --disable-vsync --script res://tests/ultimates/presentation/thief_certification_live_capture.gd"
