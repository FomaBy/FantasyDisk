#!/usr/bin/env python3
"""Build the FAN-2610 ash_marksman 8-direction PixelLab pack.
...
CHARACTER_ID = "ash_marksman"
CELL_SIZE = 512
TARGET_VISIBLE_HEIGHT = 245
BOTTOM_PADDING = 32
USER_AGENT = "FantasyDisk-FAN2610/1.0"

SOURCE_DIR = ROOT / "assets/sprites/enemies/pixellab/ash_marksman"
RUNTIME_DIR = ROOT / "assets/sprites/enemies/full_frame/ash_marksman_8dir"
SPRITEFRAMES_PATH = ROOT / "assets/sprites/enemies/full_frame/ash_marksman_spriteframes.tres"
...
def main() -> int:
    if len(sys.argv) != 2:
        print("usage: build_fan2610_ash_marksman_pack.py <dump.txt>", file=sys.stderr)
        return 2
    ...
    for direction in DIRECTIONS:
        s = suffix(direction)
        src = SOURCE_DIR / f"ash_marksman_idle_{s}.png"
        dest = RUNTIME_DIR / f"ash_marksman_idle_{s}.png"
    ...
    for state, timing in STATE_TIMING.items():
        ...
        for direction in DIRECTIONS:
            ...
            for index, url in enumerate(urls):
                src = SOURCE_DIR / f"ash_marksman_{state}_{s}_{index:02d}.png"
                dest = RUNTIME_DIR / f"ash_marksman_{state}_{s}_{index:02d}.png"
                download(url, src)
    ...
    manifest = {
        ...
        "pixellab_character_id": "55d6a246-b12e-4066-848e-4131beb6c5ed",
