...
CONFIG = {
    ...
    "soldier": {
        "source": "assets/sprites/characters/soldier.png",
        "group": "characters",
        "style": "soldier",
        "attack_part": "arm_r",
        "foot_y": 486,
        "socket": (342, 276),
        "parts": {
            "arm_l": {"crop": (144, 150, 214, 344), "pivot": (196, 172), "z": 1, "erase": (144, 150, 198, 344)},
            "arm_r": {"crop": (300, 146, 368, 334), "pivot": (316, 170), "z": 1, "erase": (320, 146, 368, 334)},
            "leg_l": {"crop": (150, 318, 236, 486), "pivot": (194, 336), "z": -1, "erase": ("below", 354)},
            "leg_r": {"crop": (244, 318, 342, 486), "pivot": (286, 336), "z": -1, "erase": ("below", 354)},
        },
    },
    "thief": {
        "source": "assets/sprites/characters/thief.png",
        "group": "characters",
        "style": "humanoid",
        "attack_part": "arm_r",
        "foot_y": 488,
        "socket": (338, 276),
        "parts": {
            "arm_l": {"crop": (144, 156, 208, 344), "pivot": (196, 178), "z": 1, "erase": (144, 156, 196, 344)},
            "arm_r": {"crop": (292, 150, 370, 342), "pivot": (314, 174), "z": 1, "erase": (316, 150, 370, 342)},
            "leg_l": {"crop": (144, 318, 236, 490), "pivot": (190, 338), "z": -1, "erase": ("below", 356)},
            "leg_r": {"crop": (236, 316, 342, 490), "pivot": (282, 338), "z": -1, "erase": ("below", 356)},
        },
    },
    "elementalist": {
        "source": "assets/sprites/characters/elementalist.png",
        "group": "characters",
        "style": "robed_walker",
        "attack_part": "arm_r",
        "foot_y": 488,
        "socket": (338, 276),
        "parts": {
            "arm_l": {"crop": (118, 150, 206, 350), "pivot": (182, 174), "z": 1, "erase": (118, 150, 178, 330)},
            "arm_r": {"crop": (318, 150, 398, 352), "pivot": (338, 174), "z": 1, "erase": (338, 150, 398, 330)},
            "leg_l": {"crop": (118, 318, 230, 490), "pivot": (178, 338), "z": -1, "erase": ("below", 356)},
            "leg_r": {"crop": (242, 318, 342, 490), "pivot": (286, 338), "z": -1, "erase": ("below", 356)},
        },
    },
    "sniper": {
        "source": "assets/sprites/characters/sniper.png",
        "group": "characters",
        "style": "sniper",
        "attack_part": "arm_r",
        "foot_y": 488,
        "socket": (340, 266),
        "parts": {
            "arm_l": {"crop": (144, 148, 214, 340), "pivot": (194, 174), "z": 1, "erase": (144, 148, 196, 340)},
            "arm_r": {"crop": (302, 146, 366, 334), "pivot": (322, 170), "z": 1, "erase": (322, 146, 366, 334)},
            "leg_l": {"crop": (142, 318, 232, 490), "pivot": (188, 338), "z": -1, "erase": ("below", 356)},
            "leg_r": {"crop": (238, 318, 344, 490), "pivot": (284, 338), "z": -1, "erase": ("below", 356)},
        },
    },
    "priest": {
        "source": "assets/sprites/characters/priest.png",
        "group": "characters",
        "style": "robed_walker",
        "attack_part": "arm_r",
        "foot_y": 488,
        "socket": (336, 274),
        "parts": {
            "arm_l": {"crop": (126, 140, 210, 334), "pivot": (190, 166), "z": 1, "erase": (126, 140, 182, 328)},
            "arm_r": {"crop": (316, 150, 386, 338), "pivot": (338, 176), "z": 1, "erase": (338, 150, 386, 332)},
            "leg_l": {"crop": (132, 318, 232, 490), "pivot": (184, 338), "z": -1, "erase": ("below", 356)},
            "leg_r": {"crop": (244, 318, 348, 490), "pivot": (288, 338), "z": -1, "erase": ("below", 356)},
        },
    },
    "biologist": {
        "source": "assets/sprites/characters/biologist.png",
        "group": "characters",
        "style": "humanoid",
        "attack_part": "arm_r",
        "foot_y": 482,
        "socket": (334, 282),
        "parts": {
            "arm_l": {"crop": (126, 148, 210, 342), "pivot": (190, 172), "z": 1, "erase": (126, 148, 184, 336)},
            "arm_r": {"crop": (306, 142, 386, 342), "pivot": (326, 168), "z": 1, "erase": (328, 142, 386, 336)},
            "leg_l": {"crop": (132, 312, 232, 482), "pivot": (184, 334), "z": -1, "erase": ("below", 350)},
            "leg_r": {"crop": (238, 310, 346, 482), "pivot": (286, 334), "z": -1, "erase": ("below", 350)},
        },
    },
    "robot": {
        "source": "assets/sprites/characters/robot.png",
        "group": "characters",
        "style": "heavy",
        "attack_part": "arm_r",
        "foot_y": 490,
        "socket": (344, 286),
        "parts": {
            "arm_l": {"crop": (72, 128, 210, 366), "pivot": (174, 150), "z": 1, "erase": (72, 128, 180, 360)},
            "arm_r": {"crop": (310, 124, 440, 366), "pivot": (336, 148), "z": 1, "erase": (336, 124, 440, 360)},
            "leg_l": {"crop": (118, 326, 234, 492), "pivot": (178, 346), "z": -1, "erase": ("below", 356)},
