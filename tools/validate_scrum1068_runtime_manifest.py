...
FINAL_ROUTE_METHODS: dict[str, tuple[str, str]] = {
    ...
    "orb_four_element_resonance": ("scripts/classes/elementalist_weapon.gd", "_elemental_square_tick"),
    "prism_intersection_rift": ("scripts/classes/elementalist_weapon.gd", "_resolve_prism_rift"),
    "meteor_shard_recall": ("scripts/classes/elementalist_weapon.gd", "_resolve_meteor_impact"),
    "deadeye_weakpoint_cycle": ("scripts/classes/sniper_weapon.gd", "_resolve_sniper_lockshot"),
    "spotter_highest_hp_priority": ("scripts/classes/sniper_weapon.gd", "_land_spotter_shell"),
    "shatter_extra_pierce_falloff": ("scripts/classes/sniper_weapon.gd", "_impact_shatter_bullet"),
    "reliquary_mark_expiry_burst": ("scripts/classes/priest_weapon.gd", "_constellation_reliquary_expire"),
    "censer_absorb_retaliation": ("scripts/classes/class_weapon_combat.gd", "constellation_owner_event"),
    "chime_owner_return_shield": ("scripts/classes/priest_weapon.gd", "_fire_priest_dual_toll"),
    "spore_final_ring_blooms": ("scripts/classes/biologist_weapon.gd", "_bio_spore_pulse"),
    "injector_sample_analysis_ramp": ("scripts/classes/biologist_weapon.gd", "_fire_bio_sample_dart"),
    "symbiote_link_transfer": ("scripts/classes/biologist_weapon.gd", "_germinate_symbiote_seed"),
    "anchor_next_heavy_hit_setup": ("scripts/classes/robot_weapon.gd", "_resolve_robot_anchor"),
    "reactor_vent_cycle_pulse": ("scripts/classes/robot_weapon.gd", "_fire_robot_reactor_vent"),
    "mine_adjacency_chain": ("scripts/classes/engineer_weapon.gd", "_detonate_engineer_mine"),
    "book_mirror_midpoint_collapse": ("scripts/classes/dark_mage_weapon.gd", "_resolve_dark_mirror_blast"),
    "skull_death_curse_transfer": ("scripts/classes/dark_mage_weapon.gd", "_constellation_transfer_skull_curse"),
    "wand_pierce_decay_echo": ("scripts/classes/dark_mage_weapon.gd", "_resolve_dark_chain_hit"),
    "guitar_riff_harmony_lane": ("scripts/classes/guitarist_weapon.gd", "_fire_riff_strip"),
    "bass_every_nth_stagger": ("scripts/classes/class_weapon_core.gd", "_fire_pulse"),
    "amp_instrument_echo": ("scripts/classes/guitarist_weapon.gd", "_constellation_instrument_echo"),
    "chakram_return_execute_mark": ("scripts/classes/assassin_weapon.gd", "_damage_boomerang_return"),
    "dagger_execute_shadow_window": ("scripts/classes/class_weapon_combat.gd", "constellation_owner_event"),
    "wire_poison_ramp_snap": ("scripts/classes/class_weapon_combat.gd", "_damage_enemy_with_dot"),
    "crossbow_full_charge_mark": ("scripts/classes/ranger_weapon.gd", "_fire_moon_split_shot"),
    "longbow_outer_storm_branch": ("scripts/classes/ranger_weapon.gd", "_fire_storm_pierce_cone"),
    "trap_prey_mark_distribution": ("scripts/classes/ranger_weapon.gd", "_trigger_hunter_trap"),
    "potion_overheal_absorb_pool": ("scripts/classes/class_weapon_core.gd", "_heal_owner_from_damage"),
    "syringe_infection_threshold_spread": ("scripts/classes/doctor_weapon.gd", "_apply_plague_infection"),
    "saw_wound_execute_heal": ("scripts/classes/doctor_weapon.gd", "_fire_saw_sector"),
    "powder_cross_reagent_combo": ("scripts/classes/chemist_weapon.gd", "_trigger_chemist_combo"),
    "acid_stack_detonation": ("scripts/classes/class_weapon_combat.gd", "_apply_pool_contact_statuses"),
    "briar_sustained_root_burst": ("scripts/classes/druid_weapon.gd", "_briar_zone_tick"),
    "totem_every_nth_raven_strike": ("scripts/classes/class_weapon_core.gd", "_fire_deployable_pulse"),
}
